...
function testArtifactsFunctionality() {
    beforeEach(function () {
        return __awaiter(this, void 0, void 0, function* () {
            const version = yield this.env.network.provider.send("web3_clientVersion");
        ...
        function shouldWorkWithoutAccounts() {
            it("Should be able to call constant functions", function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const greeterWithAt = Greeter.at("0x0000000000000000000000000000000000000001");
                    // Shouldn't throw.
...
describe("Test contracts compilation", function () {
    ...
    it("Should include sources from sources", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.assert.include(sources, fs.realpathSync(path_1.default.join("contracts", "fromContracts.sol")));
        });
    });
    it("Should include sources from test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const sources = yield this.env.run(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS);
            chai_1.assert.include(sources, fs.realpathSync(path_1.default.join("test", "fromTest.sol")));
        });
    });
    it("Should ignore non-source files from test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const sources = yield this.env.run(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS);
            chai_1.assert.notInclude(sources, fs.realpathSync(path_1.default.join("test", "shouldBeIgnored.txt")));
        });
    });
