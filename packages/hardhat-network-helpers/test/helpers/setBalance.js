...
describe("setBalance", function () {
    ...
    const getBalance = (address) => __awaiter(this, void 0, void 0, function* () {
        const balance = yield this.ctx.hre.network.provider.send("eth_getBalance", [
            address,
        ]);
        return (0, test_utils_1.rpcQuantityToNumber)(balance);
    });
    it("should allow setting the balance of a given address", function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield hh.setBalance(recipient, 1234567);
            chai_1.assert.equal(yield getBalance(recipient), 1234567);
        });
    });
    describe("accepted parameter types for balance", function () {
        ...
        for (const [type, value, expectedBalance] of balanceExamples) {
            it(`should accept balance of type ${type}`, function () {
                return __awaiter(this, void 0, void 0, function* () {
                    yield hh.setBalance(recipient, value);
                    chai_1.assert.equal(yield getBalance(recipient), expectedBalance);
                });
            });
        }
        it("should not accept strings that are not 0x-prefixed", function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield chai_1.assert.isRejected(hh.setBalance("3", 1));
            });
        });
    });
});
