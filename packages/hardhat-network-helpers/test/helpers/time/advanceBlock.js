...
describe("time#advanceBlock", function () {
    ...
    it("should increase the block height by the given number of blocks", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const initialHeight = yield hh.time.latestBlock();
            const newHeight = yield hh.time.advanceBlock(3);
            const endHeight = yield hh.time.latestBlock();
            chai_1.assert.equal(newHeight, endHeight);
            chai_1.assert.equal(initialHeight + 3, endHeight);
        });
    });
    it("should throw if given a negative number", function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield chai_1.assert.isRejected(hh.time.advanceBlock(-1));
        });
    });
    describe("accepted parameter types for blocks number", function () {
        ...
        for (const [type, value] of nonceExamples) {
            it(`should accept an argument of type ${type}`, function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const initialHeight = yield hh.time.latestBlock();
                    const newHeight = yield hh.time.advanceBlock(value);
                    const endHeight = yield hh.time.latestBlock();
                    chai_1.assert.equal(newHeight, endHeight);
