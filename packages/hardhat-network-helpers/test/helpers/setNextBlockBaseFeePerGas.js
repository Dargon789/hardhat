...
describe("setNextBlockBaseFeePerGas", function () {
    ...
    const getBaseFeePerGas = (blockNumber = "latest") => __awaiter(this, void 0, void 0, function* () {
        const block = yield this.ctx.hre.network.provider.send("eth_getBlockByNumber", [blockNumber, false]);
        return (0, test_utils_1.rpcQuantityToNumber)(block.baseFeePerGas);
    });
    it("should allow setting the next block's base fee per gas", function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield hh.setNextBlockBaseFeePerGas(1234567);
            yield hh.mine();
            chai_1.assert.equal(yield getBaseFeePerGas(), 1234567);
        });
    });
    describe("accepted parameter types for next block's base fee per gas", function () {
        const blockGasLimitExamples = [
        ...
        for (const [type, value, expectedBlockGasLimit] of blockGasLimitExamples) {
            it(`should accept blockGasLimit of type ${type}`, function () {
                return __awaiter(this, void 0, void 0, function* () {
                    yield hh.setNextBlockBaseFeePerGas(value);
                    yield hh.mine();
                    chai_1.assert.equal(yield getBaseFeePerGas(), expectedBlockGasLimit);
                });
            });
        }
        it("should not accept strings that are not 0x-prefixed", function () {
            return __awaiter(this, void 0, void 0, function* () {
                yield chai_1.assert.isRejected(hh.setNextBlockBaseFeePerGas("3"));
            });
        });
    });
});
