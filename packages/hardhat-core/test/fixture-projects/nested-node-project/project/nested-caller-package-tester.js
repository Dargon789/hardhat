...
exports.indirectlyCallFromNestedpModule =
  exports.callFromTopModule =
  exports.callFromNestedModule =
  exports.call =
    void 0;
...
function call() {
  return (0, caller_package_1.getClosestCallerPackage)();
}
exports.call = call;
...
function callFromTopModule() {
  return (0, top_caller_package_tester_1.call)();
}
exports.callFromTopModule = callFromTopModule;
function indirectlyCallFromNestedpModule() {
  return (0, top_caller_package_tester_1.callFromNestedModule)();
}
