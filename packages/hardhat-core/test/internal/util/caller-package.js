...
const nested = __importStar(
  require("../../fixture-projects/nested-node-project/project/nested-caller-package-tester")
);
const top = __importStar(
  require("../../fixture-projects/nested-node-project/top-caller-package-tester")
);
