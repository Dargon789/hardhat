...
const types = __importStar(
  require("../../../../src/internal/core/params/argumentTypes")
);
...
function assertParamDefinition(actual, expected) {
  for (const key of (0, unsafe_1.unsafeObjectKeys)(actual)) {
    if (expected[key] !== undefined) {
      chai_1.assert.deepEqual(actual[key], expected[key]);
    }
  }
}
const runSuperNop = () => __awaiter(void 0, void 0, void 0, function* () {});
...
describe("SimpleTaskDefinition", () => {
  describe("construction", () => {
    ...
    it("starts without any scope", () => {
      chai_1.assert.isUndefined(taskDefinition.scope);
    });
    it("starts with an action that throws", () => {
      (0, errors_1.expectHardhatError)(
        () => taskDefinition.action({}, {}, runSuperNop),
  ...
  describe("construction with task identifiers", () => {
    ...
    it("gets the right scope", () => {
      chai_1.assert.equal(taskDefinition.scope, "scope");
    });
    it("gets the right isSubtask flag", () => {
      chai_1.assert.isTrue(taskDefinition.isSubtask);
    });
  ...
  describe("setDescription", () => {
    it("Should change the description", () => {
      const taskDefinition = new task_definitions_1.SimpleTaskDefinition(
        "name"
      );
      chai_1.assert.isUndefined(taskDefinition.description);
  ...
  describe("setAction", () => {
    it("Should change the action", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        let result = yield taskDefinition.action({}, {}, runSuperNop);
        ...
        result = yield taskDefinition.action({}, {}, runSuperNop);
    ...
    describe("param name clashes with Hardhat's ones", () => {
      function testClashWith(name) {
        (0, errors_1.expectHardhatError)(
          ...
          errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM
        );
        (0, errors_1.expectHardhatError)(
      ...
      describe("no mandatory positional param after an optional one", () => {
        ...
        it("throws when trying to add a new positional param", () => {
          (0, errors_1.expectHardhatError)(
            ...
            errors_list_1.ERRORS.TASK_DEFINITIONS.MANDATORY_PARAM_AFTER_OPTIONAL
          );
        });
        ...
        describe("should still accept non-positional ones", () => {
          it("should accept a common param", () => {
            ...
            chai_1.assert.notEqual(
              taskDefinition.paramDefinitions.p,
              undefined
            );
          });
      ...
      describe("no positional params after a variadic positional param", () => {
        ...
        it("should throw on adding a positional param", () => {
          (0, errors_1.expectHardhatError)(
            ...
            errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_AFTER_VARIADIC
          );
        });
    ...
    describe("addParam", () => {
      it("Should fail if the param name isn't camelCase", function () {
        (0, errors_1.expectHardhatError)(
          ...
          errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING
        );
        (0, errors_1.expectHardhatError)(
      ...
      it("should use types.string as if non type is given", () => {
        taskDefinition.addParam("p");
        chai_1.assert.equal(
          taskDefinition.paramDefinitions.p.type,
          types.string
        );
      });
        ...
        describe("When using non-cli argument types", () => {
          it("Should throw on addParam", () => {
            (0, errors_1.expectHardhatError)(
              ...
              errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED
            );
          });
...
describe("OverriddenTaskDefinition", () => {
  ...
  beforeEach("init tasks", () => {
    ...
    overriddenTask = new task_definitions_1.OverriddenTaskDefinition(
      parentTask,
      true
    );
  });
  ...
  describe("inherited properties", () => {
    ...
    it("should work with more than one level of chaining", () => {
      const overriddenAgain = new task_definitions_1.OverriddenTaskDefinition(
        overriddenTask,
        false
      );
  ...
  describe("Param definitions can be added only in compatible cases", () => {
    ...
    it("should throw if adding a param of same name that was already defined in parent task", () => {
      ...
      chai_1.assert.isDefined(
        overriddenTask.paramDefinitions[definedParamName]
      );
    ...
    it("should throw if addParam is called with isOptional = false", () => {
      (0, errors_1.expectHardhatError)(
        ...
        errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_MANDATORY_PARAMS
      );
    });
    it("should add an optional param if addParam is called with isOptional = true", () => {
      ...
      chai_1.assert.isUndefined(
        overriddenTask.paramDefinitions[optParamName],
        ""
      );
      overriddenTask.addParam(
        optParamName,
    ...
    it("should throw if addPositionalParam is called", () => {
      (0, errors_1.expectHardhatError)(
        ...
        errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_POSITIONAL_PARAMS
      );
    });
    ...
    it("should throw if addVariadicPositionalParam is called", () => {
      (0, errors_1.expectHardhatError)(
        ...
        errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_VARIADIC_PARAMS
      );
    });
...
describe("SimpleScopeDefinition", () => {
  it("should create a scope definition without a description", function () {
    return __awaiter(this, void 0, void 0, function* () {
      const scopeDefinition = new task_definitions_1.SimpleScopeDefinition(
        "scope",
        undefined,
        () => {},
        () => {}
      );
      chai_1.assert.equal(scopeDefinition.name, "scope");
      chai_1.assert.isUndefined(scopeDefinition.description);
    });
  });
  it("should create a scope definition with a description", function () {
    return __awaiter(this, void 0, void 0, function* () {
      const scopeDefinition = new task_definitions_1.SimpleScopeDefinition(
        "scope",
        "a description",
      ...
      chai_1.assert.equal(scopeDefinition.name, "scope");
      chai_1.assert.equal(scopeDefinition.description, "a description");
    });
  });
  it("should change the description with setDescription", function () {
    return __awaiter(this, void 0, void 0, function* () {
      const scopeDefinition = new task_definitions_1.SimpleScopeDefinition(
        "scope",
        "a description",
      ...
      chai_1.assert.equal(scopeDefinition.description, "another description");
    });
  });
  it("should call the right callbacks", function () {
    return __awaiter(this, void 0, void 0, function* () {
      const addTask = sinon_1.default.spy();
      const addSubtask = sinon_1.default.spy();
      const scopeDefinition = new task_definitions_1.SimpleScopeDefinition(
        "scope",
        "a description",
        addTask,
      ...
      chai_1.assert.isFalse(addTask.called);
      chai_1.assert.isFalse(addSubtask.called);
      const taskAction = () => {};
      scopeDefinition.task("task", taskAction);
      chai_1.assert.isTrue(addTask.calledOnce);
      chai_1.assert.isFalse(addSubtask.called);
      const subtaskAction = () => {};
      scopeDefinition.subtask("subtask", subtaskAction);
      chai_1.assert.isTrue(addTask.calledOnce);
      chai_1.assert.isTrue(addSubtask.calledOnce);
    });
  });
});
