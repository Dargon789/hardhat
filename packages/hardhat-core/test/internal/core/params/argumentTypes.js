...
describe("argumentTypes", () => {
  ...
  describe("bigint type", () => {
    it("should work with decimal values", () => {
      chai_1.assert.equal(types.bigint.parse("arg", "0"), 0n);
      chai_1.assert.equal(types.bigint.parse("arg", "1"), 1n);
      chai_1.assert.equal(types.bigint.parse("arg", "1123"), 1123n);
      chai_1.assert.equal(types.bigint.parse("arg", "05678"), 5678n);
      chai_1.assert.equal(
    ...
    it("should work with hex values", () => {
      chai_1.assert.equal(types.bigint.parse("arg", "0x0"), BigInt(0));
      chai_1.assert.equal(types.bigint.parse("arg", "0x1"), BigInt(1));
      chai_1.assert.equal(types.bigint.parse("arg", "0xA"), BigInt(0xa));
      chai_1.assert.equal(types.bigint.parse("arg", "0xa"), BigInt(0xa));
      chai_1.assert.equal(types.bigint.parse("arg", "0x0a"), BigInt(0x0a));
      chai_1.assert.equal(
    ...
    it("should work with bigint values with 'n' suffix", () => {
      chai_1.assert.equal(types.bigint.parse("arg", "0n"), BigInt(0));
    });
    it("should fail with incorrect values", () => {
      (0, errors_1.expectHardhatError)(
  ...
  describe("Input file type", () => {
    ...
    it("Should work with an absolute path", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const absolute = yield (0, fs_utils_1.getRealPath)(__filename);
    ...
    it("Should throw if the file doesnt exist", () => {
      (0, errors_1.expectHardhatError)(
        ...
        errors_list_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE
      );
    });
  ...
  describe("JSON type", () => {
    it("Should fail if the argument isn't JSON", () => {
      (0, errors_1.expectHardhatError)(
        ...
        errors_list_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT
      );
      (0, errors_1.expectHardhatError)(
