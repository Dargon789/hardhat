...
function privateKeyToAddress(privateKey) {
  return (0, util_1.bytesToHex)(
    (0, util_1.privateToAddress)(toBuffer(privateKey))
  );
}
...
describe("Local accounts provider", () => {
  ...
  beforeEach(() => {
    ...
    mock.setReturnValue(
      "net_version",
      (0, base_types_1.numberToRpcQuantity)(MOCK_PROVIDER_CHAIN_ID)
    );
    mock.setReturnValue(
      "eth_getTransactionCount",
      (0, base_types_1.numberToRpcQuantity)(0x8)
    );
    mock.setReturnValue("eth_accounts", []);
    wrapper = new accounts_1.LocalAccountsProvider(mock, accounts);
  });
  it("Should return the account addresses in eth_accounts", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield wrapper.request({
        method: "eth_accounts",
      });
  ...
  it("Should return the account addresses in eth_requestAccounts", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield wrapper.request({
  ...
  it("Should throw when calling sendTransaction without gas", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const params = [
        {
          from: privateKeyToAddress(accounts[0]),
          to: "0x2a97a65d5673a2c61e95ce33cecadf24f654f96d",
          gasPrice: (0, base_types_1.numberToRpcQuantity)(0x3b9aca00),
          nonce: (0, base_types_1.numberToRpcQuantity)(0x8),
        },
      ];
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "gas");
    }));
  it("Should throw when calling sendTransaction without gasPrice, maxFeePerGas and maxPriorityFeePerGas", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const params = [
        {
          from: privateKeyToAddress(accounts[0]),
          to: "0x2a97a65d5673a2c61e95ce33cecadf24f654f96d",
          nonce: (0, base_types_1.numberToRpcQuantity)(0x8),
          gas: (0, base_types_1.numberToRpcQuantity)(123),
        },
      ];
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_FEE_PRICE_FIELDS);
    }));
  it("Should throw when calling sendTransaction with gasPrice and EIP1559 fields", function () {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const params2 = [
        Object.assign(Object.assign({}, params[0]), {
          maxFeePerGas: undefined,
          maxPriorityFeePerGas: (0, base_types_1.numberToRpcQuantity)(1),
        }),
      ];
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.INCOMPATIBLE_FEE_PRICE_FIELDS);
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params: params2 }), errors_list_1.ERRORS.NETWORK.INCOMPATIBLE_FEE_PRICE_FIELDS);
    });
  });
  it("Should throw when only one EIP1559 field is provided", function () {
    return __awaiter(this, void 0, void 0, function* () {
      const params = [
        {
          from: privateKeyToAddress(accounts[0]),
      ...
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "maxPriorityFeePerGas");
      yield (0,
      errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params: params2 }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "maxFeePerGas");
    });
  });
  it("Should, given two identical tx, return send the same raw transaction", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield wrapper.request({
        ...
        params: [
          {
            ...
            gasPrice: (0, base_types_1.numberToRpcQuantity)(678912),
  ...
  it("Should throw if trying to send from an account that isn't local", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield (0, errors_2.expectHardhatErrorAsync)(
        () =>
          wrapper.request({
            method: "eth_sendTransaction",
            params: [
  ...
  it("Should forward other methods", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const input = [1, 2];
      yield wrapper.request({ method: "eth_sarasa", params: input });
      chai_1.assert.deepEqual(mock.getLatestParams("eth_sarasa"), input);
    }));
  it("Should get the nonce if not provided", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield wrapper.request({
        method: "eth_sendTransaction",
        params: [
  ...
  it("should send eip1559 txs if the eip1559 fields are present", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        to: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        ...
        nonce: (0, base_types_1.numberToRpcQuantity)(0),
        value: (0, base_types_1.numberToRpcQuantity)(1),
        chainId: (0, base_types_1.numberToRpcQuantity)(MOCK_PROVIDER_CHAIN_ID),
        maxFeePerGas: (0, base_types_1.numberToRpcQuantity)(12),
      ...
      chai_1.assert.equal(rawTransaction[0], 2);
    }));
  it("should send access list transactions", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        to: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
  ...
  it("should send EIP-7702 transactions", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266",
        to: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266",
        gas: (0, base_types_1.numberToRpcQuantity)(100000),
        maxFeePerGas: (0, base_types_1.numberToRpcQuantity)(10n * 10n ** 9n),
        maxPriorityFeePerGas: (0, base_types_1.numberToRpcQuantity)(10n ** 9n),
        chainId: (0, base_types_1.numberToRpcQuantity)(MOCK_PROVIDER_CHAIN_ID),
        nonce: (0, base_types_1.numberToRpcQuantity)(0),
        authorizationList: [
          {
            chainId: (0, base_types_1.numberToRpcQuantity)(
  ...
  it("should allow 'to' to be undefined (contract deployment)", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        gas: (0, base_types_1.numberToRpcQuantity)(100000),
  ...
  it("should allow 'data' to be undefined (regular tx)", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        to: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
  ...
  it("should allow 'chainId' to be larger than 2^32 - 1", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        to: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        ...
        nonce: (0, base_types_1.numberToRpcQuantity)(0),
        value: (0, base_types_1.numberToRpcQuantity)(1),
        chainId: (0, base_types_1.numberToRpcQuantity)(BigInt(2 ** 32)),
        maxFeePerGas: (0, base_types_1.numberToRpcQuantity)(12),
        maxPriorityFeePerGas: (0, base_types_1.numberToRpcQuantity)(2),
      };
      yield wrapper.request({
  ...
  it("should throw if both 'to' and 'data' are undefined", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield (0, errors_2.expectHardhatErrorAsync)(
        () =>
          wrapper.request({
  ...
  it("should throw if 'authorizationList' and 'gasPrice' are defined", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield (0, errors_2.expectHardhatErrorAsync)(
        () =>
          wrapper.request({
  ...
  it("should add the chainId value if it's missing", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const tx = {
        from: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
        to: "0xb5bc06d4548a3ac17d72b372ae1e416bf65b8ead",
  ...
  describe("eth_sign", () => {
    it("Should be compatible with parity's implementation", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Should be compatible with ganache-cli's implementation", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Should be compatible with geth's implementation", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Should throw if no data is given", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        yield chai_1.assert.isRejected(
          ...
          errors_1.InvalidArgumentsError
        );
      }));
    it("Should throw if the address isn't one of the local ones", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        yield (0, errors_2.expectHardhatErrorAsync)(
          () =>
            wrapper.request({
    ...
    it("Should just forward if no address is given", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        yield wrapper.request({ method: "eth_sign" });
        chai_1.assert.deepEqual(mock.getLatestParams("eth_sign"), []);
      }));
  });
  describe("eth_signTypedData_v4", () => {
    it("Should be compatible with EIP-712 example", () =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("Should be compatible with stringified JSON input", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const provider = new accounts_1.LocalAccountsProvider(mock, [
          // keccak256("cow")
          "0xc85ef7d79691fe79573b1a7064c19c1a9819ebdbd1faaab1a8ec92344438aaf4",
    ...
    it("Should throw if data string input is not JSON", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        yield (0, errors_2.expectHardhatErrorAsync)(
          () =>
            wrapper.request({
    ...
    it("Should just forward if the address isn't one of the local ones", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        yield wrapper.request({
          method: "eth_signTypedData_v4",
          params: ["0x000006d4548a3ac17d72b372ae1e416bf65b8ead", {}],
        });
        chai_1.assert.deepEqual(mock.getLatestParams("eth_signTypedData_v4"), [
          "0x000006d4548a3ac17d72b372ae1e416bf65b8ead",
          {},
        ]);
      }));
  ...
  describe("personal_sign", () => {
    ...
    it("Should be compatible with metamask's implementation", () =>
      __awaiter(void 0, void 0, void 0, function* () {
...
describe("hdwallet provider", () => {
  ...
  it("should generate a valid address with passphrase", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const passphrase = "this is a secret";
      wrapper = new accounts_1.HDWalletProvider(
        mock,
        mnemonic,
        hdpath,
        0,
      ...
      chai_1.assert.equal(
        response[0],
        "0x6955b833d195e49c07fc56fbf0ec387325facb87"
      );
    }));
  it("should generate a valid address when given a different index", () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it("should generate 2 accounts", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      wrapper = new accounts_1.HDWalletProvider(mock, mnemonic, hdpath, 0, 2);
      const response = yield wrapper.request({ method: "eth_accounts" });
  ...
  describe("HDPath formatting", () => {
    it("Should work if it doesn't end in a /", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        wrapper = new accounts_1.HDWalletProvider(
          mock,
          mnemonic,
    ...
    it("Should throw if the path is invalid", () => {
      (0, errors_2.expectHardhatError)(
        () => new accounts_1.HDWalletProvider(mock, mnemonic, ""),
        errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH
      );
      (0, errors_2.expectHardhatError)(
        () => new accounts_1.HDWalletProvider(mock, mnemonic, "m/"),
        errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH
      );
      (0, errors_2.expectHardhatError)(
        () => new accounts_1.HDWalletProvider(mock, mnemonic, "m//"),
      ...
      (0, errors_2.expectHardhatError)(
        () => new accounts_1.HDWalletProvider(mock, mnemonic, "m/0''"),
        errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH
      );
      (0, errors_2.expectHardhatError)(
        () => new accounts_1.HDWalletProvider(mock, mnemonic, "ghj"),
        errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH
      );
    });
  });
...
describe("Sender providers", () => {
  ...
  describe("FixedSenderProvider", function () {
    beforeEach(function () {
      wrapper = new accounts_1.FixedSenderProvider(
        mock,
        "0x2a97a65d5673a2c61e95ce33cecadf24f654f96d"
      );
    });
    it("Should set the from value into the transaction", () =>
      __awaiter(this, void 0, void 0, function* () {
        yield wrapper.request({ method: "eth_sendTransaction", params: [tx] });
    ...
    it("Should not replace transaction's from", () =>
      __awaiter(this, void 0, void 0, function* () {
  ...
  describe("AutomaticSenderProvider", function () {
    ...
    it("Should use the first account if from is missing", () =>
      __awaiter(this, void 0, void 0, function* () {
        yield wrapper.request({ method: "eth_sendTransaction", params: [tx] });
        const params = mock.getLatestParams("eth_sendTransaction");
        chai_1.assert.equal(
    ...
    it("Should not fail on eth_calls if provider doesn't have any accounts", () =>
      __awaiter(this, void 0, void 0, function* () {
        mock.setReturnValue("eth_accounts", []);
        tx.value = "asd";
        yield wrapper.request({ method: "eth_call", params: [tx] });
 ...
 */
function validateRawEIP2930Transaction(rawTx, tx) {
  const sentTx = micro_eth_signer_1.Transaction.fromHex(rawTx);
  chai_1.assert.equal(sentTx.type, "eip2930");
  // We need to cast as the type assertion isn't narrowing the type
  const parsedTx = sentTx;
  chai_1.assert.equal(parsedTx.sender.toLowerCase(), tx.from);
  chai_1.assert.equal(parsedTx.raw.to.toLowerCase(), tx.to);
  ...
  chai_1.assert.equal(
    (0, base_types_1.numberToRpcQuantity)(parsedTx.raw.gasLimit),
    tx.gas
  );
  chai_1.assert.equal(
    (0, base_types_1.numberToRpcQuantity)(parsedTx.raw.gasPrice),
    tx.gasPrice
  );
  chai_1.assert.equal(
    (0, base_types_1.numberToRpcQuantity)(parsedTx.raw.nonce),
    tx.nonce
  );
  chai_1.assert.equal(
    (0, base_types_1.numberToRpcQuantity)(parsedTx.raw.value),
    tx.value
  );
  chai_1.assert.deepEqual(parsedTxAccessList, tx.accessList);
}
