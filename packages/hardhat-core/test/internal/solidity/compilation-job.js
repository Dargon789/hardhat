...
describe("Compilation jobs", function () {
  describe("createCompilationJobFromFile", function () {
    describe("single file", function () {
      it("valid compiler", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const [dependencyGraph, [Foo]] = yield (0, helpers_1.createMockData)([
            { file: FooMock },
          ]);
          const compilationJobOrError = yield (0,
          compilation_job_1.createCompilationJobFromFile)(
            dependencyGraph,
            Foo,
            solcConfig055
          );
      ...
      it("newest compiler is used", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", [">=0.5.0"]);
          const [dependencyGraph, [Foo]] = yield (0, helpers_1.createMockData)([
            { file: FooMock },
      ...
      it("overriden compiler is used", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", [">=0.5.0"]);
          const [dependencyGraph, [Foo]] = yield (0, helpers_1.createMockData)([
            { file: FooMock },
          ...
          compilation_job_1.createCompilationJobFromFile)(
            dependencyGraph,
            Foo,
            Object.assign(Object.assign({}, solcConfig066), {
              overrides: {
      ...
      it("invalid overriden compiler", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const [dependencyGraph, [Foo]] = yield (0, helpers_1.createMockData)([
            { file: FooMock },
          ...
          compilation_job_1.createCompilationJobFromFile)(
            dependencyGraph,
            Foo,
            Object.assign(Object.assign({}, solcConfig055), {
              overrides: {
    ...
    describe("two files", function () {
      it("file not imported is not included in job", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
      ...
      it("file imported is included in job", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const BarMock = new helpers_1.MockFile("Bar", ["^0.5.0"]);
          const [dependencyGraph, [Foo, Bar]] = yield (0,
          ...
          const compilationJob = assertIsJob(compilationJobOrError);
          chai_1.assert.equal(compilationJob.getSolcConfig().version, "0.5.5");
          chai_1.assert.sameMembers(compilationJob.getResolvedFiles(), [
            Foo,
            Bar,
          ]);
          chai_1.assert.isTrue(compilationJob.emitsArtifacts(Foo));
      ...
      it("importer file is not included in job", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const BarMock = new helpers_1.MockFile("Bar", ["^0.5.0"]);
          const [dependencyGraph, [Foo]] = yield (0, helpers_1.createMockData)([
      ...
      it("incompatible import", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
    ...
    describe("three files", function () {
      it("transitive dependency", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const BarMock = new helpers_1.MockFile("Bar", ["^0.5.0"]);
          const QuxMock = new helpers_1.MockFile("Qux", ["^0.5.0"]);
          const [dependencyGraph, [Foo, Bar, Qux]] = yield (0,
          helpers_1.createMockData)([
            { file: FooMock, dependencies: [BarMock] },
      ...
      it("imported by one and importing one", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
          const BarMock = new helpers_1.MockFile("Bar", ["^0.5.0"]);
          const QuxMock = new helpers_1.MockFile("Qux", ["^0.5.0"]);
          const [dependencyGraph, [, Bar, Qux]] = yield (0,
          helpers_1.createMockData)([
            { file: FooMock, dependencies: [BarMock] },
            { file: BarMock, dependencies: [QuxMock] },
            { file: QuxMock },
  ...
  describe("createCompilationJobsFromConnectedComponent", function () {
    it("single file (success)", function () {
      return __awaiter(this, void 0, void 0, function* () {
        const FooMock = new helpers_1.MockFile("Foo", ["^0.5.0"]);
        const [dependencyGraph] = yield (0, helpers_1.createMockData)([
          { file: FooMock },
        ]);
        const { jobs, errors } = yield (0,
        compilation_job_1.createCompilationJobsFromConnectedComponent)(
          dependencyGraph,
          (file) =>
            (0, compilation_job_1.createCompilationJobFromFile)(
              dependencyGraph,
              file,
              solcConfig055
            )
    ...
    it("files without solc bug", function () {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    it("files with solc bug", function () {
      return __awaiter(this, void 0, void 0, function* () {
        const Importer1Mock = new helpers_1.MockFile("Importer1", ["^0.5.0"]);
        const Importer2Mock = new helpers_1.MockFile("Importer2", ["^0.5.0"]);
        const ImportedMock = new helpers_1.MockFile("Imported", ["^0.5.0"]);
