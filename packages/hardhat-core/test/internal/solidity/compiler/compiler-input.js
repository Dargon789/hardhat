...
describe("compiler-input module", function () {
  it("Should construct the right input for a compilation job", () =>
    __awaiter(this, void 0, void 0, function* () {
      ...
      const input = (0, compiler_input_1.getInputFromCompilationJob)(job);
      ...
      const inputWithEvmVersion = (0,
      compiler_input_1.getInputFromCompilationJob)(jobWithEvmVersion);
