...
describe("Lock", function () {
  ...
  function deployOneYearLockFixture() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const [owner, otherAccount] = yield hardhat_1.default.ethers.getSigners();
      const Lock = yield hardhat_1.default.ethers.getContractFactory("Lock");
  ...
  describe("Deployment", function () {
    ...
    it("Should receive and store the funds to lock", function () {
      return __awaiter(this, void 0, void 0, function* () {
        const { lock, lockedAmount } = yield (0, network_helpers_1.loadFixture)(
          deployOneYearLockFixture
        );
        (0, chai_1.expect)(
          yield hardhat_1.default.ethers.provider.getBalance(lock.target)
  ...
  describe("Withdrawals", function () {
    describe("Validations", function () {
      it("Should revert with the right error if called too soon", function () {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          yield (0, chai_1.expect)(lock.withdraw()).to.be.revertedWith(
    ...
    describe("Events", function () {
      it("Should emit an event on withdrawals", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const { lock, unlockTime, lockedAmount } = yield (0,
          network_helpers_1.loadFixture)(deployOneYearLockFixture);
          yield network_helpers_1.time.increaseTo(unlockTime);
    ...
    describe("Transfers", function () {
      it("Should transfer the funds to the owner", function () {
        return __awaiter(this, void 0, void 0, function* () {
          const { lock, unlockTime, lockedAmount, owner } = yield (0,
          network_helpers_1.loadFixture)(deployOneYearLockFixture);
          yield network_helpers_1.time.increaseTo(unlockTime);
          yield (0, chai_1.expect)(lock.withdraw()).to.changeEtherBalances(
            [owner, lock],
