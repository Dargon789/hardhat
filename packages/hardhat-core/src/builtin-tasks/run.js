...
(0, config_env_1.task)(
  ...
  .setAction(({ script, noCompile }, { run, hardhatArguments }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      if (!(yield fs_extra_1.default.pathExists(script))) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.BUILTIN_TASKS.RUN_FILE_NOT_FOUND,
          {
            script,
          }
        );
      ...
      try {
        process.exitCode = yield (0, scripts_runner_1.runScriptWithHardhat)(
          hardhatArguments,
          script
        );
      } catch (error) {
        if (error instanceof Error) {
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.BUILTIN_TASKS.RUN_SCRIPT_ERROR,
            {
              script,
              error: error.message,
            },
