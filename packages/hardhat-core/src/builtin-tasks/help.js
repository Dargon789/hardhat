...
(0, config_env_1.task)(task_names_1.TASK_HELP, "Prints this message")
  ...
  .setAction(({ scopeOrTask, task: taskName }, { tasks, scopes, version }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const helpPrinter = new HelpPrinter_1.HelpPrinter(
        constants_1.HARDHAT_NAME,
        constants_1.HARDHAT_EXECUTABLE_NAME,
        version,
