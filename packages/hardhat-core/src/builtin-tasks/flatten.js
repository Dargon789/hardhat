    ...
    if (error instanceof Error) {
      if (error.toString().includes("Error: There is a cycle in the graph.")) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.BUILTIN_TASKS.FLATTEN_CYCLE,
          {},
          error
        );
      }
  ...
  .setAction(({ files }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const dependencyGraph = yield run(
        task_names_1.TASK_FLATTEN_GET_DEPENDENCY_GRAPH,
        { files }
      );
      let flattened = "";
...
(0, config_env_1.subtask)(task_names_1.TASK_FLATTEN_GET_DEPENDENCY_GRAPH)
  ...
  .setAction(({ files }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const sourcePaths =
        files === undefined
          ? yield run(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS)
...
(0, config_env_1.task)(
  ...
  .setAction(({ files, output }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const [flattenedFile, metadata] = yield run(
        task_names_1.TASK_FLATTEN_GET_FLATTENED_SOURCE_AND_METADATA,
        { files }
      );
      if (output !== undefined) {
        (0, node_fs_1.writeFileSync)(output, flattenedFile, {
          encoding: "utf-8",
        });
      } else {
