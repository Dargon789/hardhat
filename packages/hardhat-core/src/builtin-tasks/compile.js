...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS)
  ...
  .setAction(({ sourcePath }, { config }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0,
      fs_utils_1.getAllFilesMatching)(sourcePath !== null && sourcePath !== void 0 ? sourcePath : config.paths.sources, (f) => f.endsWith(".sol"));
    })
  );
/**
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_NAMES)
  ...
  .setAction(({ rootPath, sourcePaths }, { config }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return Promise.all(
        sourcePaths.map((p) =>
          (0, source_names_1.localPathToSourceName)(
            rootPath !== null && rootPath !== void 0
              ? rootPath
              : config.paths.root,
            p
          )
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_READ_FILE)
  ...
  .setAction(({ absolutePath }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        return yield fs_extra_1.default.readFile(absolutePath, {
          encoding: "utf8",
        });
      } catch (e) {
 ...
 * by the resolver.
 */
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_GET_REMAPPINGS).setAction(
  () =>
    __awaiter(void 0, void 0, void 0, function* () {
      return {};
    })
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_GET_DEPENDENCY_GRAPH
)
  .addOptionalParam("rootPath", undefined, undefined, config_env_1.types.string)
  ...
  .addOptionalParam(
    ...
    undefined,
    undefined,
    config_env_1.types.any
  )
  .setAction(({ rootPath, sourceNames, solidityFilesCache }, { config, run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const parser = new parse_1.Parser(solidityFilesCache);
      const remappings = yield run(task_names_1.TASK_COMPILE_GET_REMAPPINGS);
      const resolver = new resolver_1.Resolver(
        rootPath !== null && rootPath !== void 0 ? rootPath : config.paths.root,
        parser,
        remappings,
        (absolutePath) =>
          run(task_names_1.TASK_COMPILE_SOLIDITY_READ_FILE, { absolutePath }),
        (importName) =>
          run(task_names_1.TASK_COMPILE_TRANSFORM_IMPORT_NAME, {
            importName,
      ...
      return dependencyGraph_1.DependencyGraph.createFromResolvedFiles(
        resolver,
        resolvedFiles
      );
    })
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILATION_JOB_FOR_FILE
)
  ...
  .setAction(({ dependencyGraph, file }, { config }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0,
      compilation_job_1.createCompilationJobFromFile)(dependencyGraph, file, config.solidity);
    })
  );
/**
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILATION_JOBS
)
  .addParam("dependencyGraph", undefined, undefined, config_env_1.types.any)
  .addOptionalParam(
    "solidityFilesCache",
  ...
  .setAction(({ dependencyGraph, solidityFilesCache }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const compilationJobsCreationResults = yield Promise.all(
        connectedComponents.map((graph) =>
          (0, compilation_job_1.createCompilationJobsFromConnectedComponent)(
            graph,
            (file) =>
              run(
                task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILATION_JOB_FOR_FILE,
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_FILTER_COMPILATION_JOBS
)
  ...
  .setAction(({ compilationJobs, force, solidityFilesCache }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      (0,
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_MERGE_COMPILATION_JOBS
)
  .addParam("compilationJobs", undefined, undefined, config_env_1.types.any)
  .setAction(({ compilationJobs }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0,
      compilation_job_1.mergeCompilationJobsWithoutBug)(compilationJobs);
    })
  );
/**
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_NOTHING_TO_COMPILE
)
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_JOBS)
  ...
  .setAction(({ compilationJobs, quiet, concurrency }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      if (compilationJobs.length === 0) {
        log(`No compilation jobs to compile`);
        yield run(task_names_1.TASK_COMPILE_SOLIDITY_LOG_NOTHING_TO_COMPILE, {
          quiet,
        });
      ...
      for (const job of compilationJobs) {
        ...
        if (
          ...
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.BUILTIN_TASKS.COMPILE_TASK_UNSUPPORTED_SOLC_VERSION,
            {
              version: solcVersion,
      ...
      const { default: pMap } = yield Promise.resolve().then(() =>
        __importStar(require("p-map"))
      );
      const pMapOptions = { concurrency, stopOnError: false };
      try {
        const artifactsEmittedPerJob = yield pMap(
          compilationJobs,
          (compilationJob, compilationJobIndex) =>
            __awaiter(void 0, void 0, void 0, function* () {
              const result = yield run(
                task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_JOB,
                {
                  compilationJob,
                  compilationJobs,
                  compilationJobIndex,
        ...
        for (const error of e) {
          if (
            !errors_1.HardhatError.isHardhatErrorType(
              error,
              errors_list_1.ERRORS.BUILTIN_TASKS.COMPILE_FAILURE
            )
          ) {
            // eslint-disable-next-line @nomicfoundation/hardhat-internal-rules/only-hardhat-error
            throw error;
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILER_INPUT)
  ...
  .setAction(({ compilationJob }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0, compiler_input_1.getInputFromCompilationJob)(compilationJob);
    })
  );
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_DOWNLOAD_COMPILER_START
)
  .addParam(
    "isCompilerDownloaded",
    undefined,
    undefined,
    config_env_1.types.boolean
  )
  .addParam("quiet", undefined, undefined, config_env_1.types.boolean)
  .addParam("solcVersion", undefined, undefined, config_env_1.types.string)
  .setAction(({ isCompilerDownloaded, solcVersion }) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_DOWNLOAD_COMPILER_END
)
  .addParam(
    "isCompilerDownloaded",
    undefined,
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_GET_SOLC_BUILD)
  .addParam("quiet", undefined, undefined, config_env_1.types.boolean)
  .addParam("solcVersion", undefined, undefined, config_env_1.types.string)
  .setAction(({ quiet, solcVersion }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const compiler = yield downloader.getCompiler(solcVersion);
      ...
      const wasmCompiler = yield wasmDownloader.getCompiler(solcVersion);
      (0,
      errors_1.assertHardhatInvariant)(wasmCompiler !== undefined, `WASM build of solc ${solcVersion} isn't working`);
      return wasmCompiler;
    })
  );
/**
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_RUN_SOLC)
  ...
  .setAction(({ input, solcPath, solcVersion }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      if (
        solcVersion !== undefined &&
        semver_1.default.valid(solcVersion) === null
      ) {
        throw new errors_1.HardhatError(
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_SOLC)
  ...
  .setAction(
    (
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        const solcBuild = yield run(
          task_names_1.TASK_COMPILE_SOLIDITY_GET_SOLC_BUILD,
          {
            quiet,
            solcVersion,
          }
        );
        yield run(task_names_1.TASK_COMPILE_SOLIDITY_LOG_RUN_COMPILER_START, {
          compilationJob,
          compilationJobs,
          compilationJobIndex,
          quiet,
        ...
        if (solcBuild.isSolcJs) {
          output = yield run(task_names_1.TASK_COMPILE_SOLIDITY_RUN_SOLCJS, {
            input,
            solcJsPath: solcBuild.compilerPath,
          });
        } else {
          output = yield run(task_names_1.TASK_COMPILE_SOLIDITY_RUN_SOLC, {
            input,
            solcPath: solcBuild.compilerPath,
            solcVersion,
          });
        }
        yield run(task_names_1.TASK_COMPILE_SOLIDITY_LOG_RUN_COMPILER_END, {
          compilationJob,
          compilationJobs,
          compilationJobIndex,
          output,
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_COMPILE,
  (taskArgs, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_COMPILATION_ERRORS
)
  ...
  .setAction(({ output }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      if (
        (output === null || output === void 0 ? void 0 : output.errors) ===
        undefined
      ) {
        return;
      }
      for (const error of output.errors) {
        if (error.severity === "error") {
          const errorMessage =
            (_a = getFormattedInternalCompilerErrorMessage(error)) !== null &&
            _a !== void 0
              ? _a
              : error.formattedMessage;
          console.error(
            errorMessage.replace(/^\w+:/, (t) =>
              picocolors_1.default.bold(picocolors_1.default.red(t))
            )
          );
        } else {
          console.warn(
            error.formattedMessage.replace(/^\w+:/, (t) =>
              picocolors_1.default.bold(picocolors_1.default.yellow(t))
            )
          );
        }
      }
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_CHECK_ERRORS)
  .addParam("output", undefined, undefined, config_env_1.types.any)
  .addParam("quiet", undefined, undefined, config_env_1.types.boolean)
  .setAction(({ output, quiet }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield run(task_names_1.TASK_COMPILE_SOLIDITY_LOG_COMPILATION_ERRORS, {
        output,
        quiet,
      });
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_EMIT_ARTIFACTS)
  ...
  .setAction(
    ({ compilationJob, input, output, solcBuild }, { artifacts, run }) =>
      __awaiter(void 0, void 0, void 0, function* () {
        const pathToBuildInfo = yield artifacts.saveBuildInfo(
          compilationJob.getSolcConfig().version,
          solcBuild.longVersion,
          input,
          output
        );
        const artifactsEmittedPerFile = yield Promise.all(
          compilationJob
            .getResolvedFiles()
            ...
            .map((file) =>
              __awaiter(void 0, void 0, void 0, function* () {
                var _b, _c;
                const artifactsEmitted = yield Promise.all(
                  Object.entries(
                    (_c =
                      (_b = output.contracts) === null || _b === void 0
                        ? void 0
                        : _b[file.sourceName]) !== null && _c !== void 0
                      ? _c
                      : {}
                  ).map(([contractName, contractOutput]) =>
                    __awaiter(void 0, void 0, void 0, function* () {
                      log(`Emitting artifact for contract '${contractName}'`);
                      const artifact = yield run(
                        task_names_1.TASK_COMPILE_SOLIDITY_GET_ARTIFACT_FROM_COMPILATION_OUTPUT,
                        {
...
(0, config_env_1.subtask)(
  ...
  .setAction(({ sourceName, contractName, contractOutput }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0,
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_RUN_COMPILER_START
)
  .addParam("compilationJob", undefined, undefined, config_env_1.types.any)
  .addParam("compilationJobs", undefined, undefined, config_env_1.types.any)
  .addParam("compilationJobIndex", undefined, undefined, config_env_1.types.int)
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_RUN_COMPILER_END
)
  .addParam("compilationJob", undefined, undefined, config_env_1.types.any)
  .addParam("compilationJobs", undefined, undefined, config_env_1.types.any)
  .addParam("compilationJobIndex", undefined, undefined, config_env_1.types.int)
  ...
  .setAction(
    (
      ...
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const input = yield run(
          task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILER_INPUT,
          {
            compilationJob,
          }
        );
        const { output, solcBuild } = yield run(
          task_names_1.TASK_COMPILE_SOLIDITY_COMPILE,
          {
        ...
        yield run(task_names_1.TASK_COMPILE_SOLIDITY_CHECK_ERRORS, {
          output,
          quiet,
        });
        let artifactsEmittedPerFile = [];
        if (emitsArtifacts) {
          artifactsEmittedPerFile = (yield run(
            task_names_1.TASK_COMPILE_SOLIDITY_EMIT_ARTIFACTS,
            {
              compilationJob,
              input,
              output,
 ...
 */
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_HANDLE_COMPILATION_JOBS_FAILURES
)
  .addParam(
  ...
  .setAction(({ compilationJobsCreationErrors }, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (hasErrors) {
        ...
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.BUILTIN_TASKS.COMPILATION_JOBS_CREATION_FAILURE,
          {
            reasons,
          }
        );
...
(0, config_env_1.subtask)(
  ...
  .setAction(({ compilationJobsCreationErrors: errors }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _d, _e, _f, _g;
...
`;
        for (const error of directlyImportsIncompatibleFile) {
          ...
          const { versionPragmas } = error.file.content;
          const versionsRange = versionPragmas.join(" ");
          const incompatibleDirectImportsFiles =
            (_e =
              (_d = error.extra) === null || _d === void 0
                ? void 0
                : _d.incompatibleDirectImports) !== null && _e !== void 0
              ? _e
              : [];
          const incompatibleDirectImports = incompatibleDirectImportsFiles.map(
            (x) => `${x.sourceName} (${x.content.versionPragmas.join(" ")})`
          );
          log(
          ...
          if (incompatibleDirectImports.length === 1) {
            ...
            } and ${otherImportsCount} other ${(0, strings_1.pluralize)(
              otherImportsCount,
              "file"
...
`;
        for (const error of indirectlyImportsIncompatibleFile) {
          ...
          const incompatibleIndirectImports =
            (_g =
              (_f = error.extra) === null || _f === void 0
                ? void 0
                : _f.incompatibleIndirectImports) !== null && _g !== void 0
              ? _g
              : [];
...
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_SOLIDITY_LOG_COMPILATION_RESULT
)
  .addParam("compilationJobs", undefined, undefined, config_env_1.types.any)
  .addParam("quiet", undefined, undefined, config_env_1.types.boolean)
  .setAction(({ compilationJobs }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      for (const job of compilationJobs) {
        ...
        const evmTarget =
          (_j =
            (_h = job.getSolcConfig().settings) === null || _h === void 0
              ? void 0
              : _h.evmVersion) !== null && _j !== void 0
            ? _j
      ...
      if (count > 0) {
        console.log(
          `Compiled ${count} Solidity ${(0, strings_1.pluralize)(
            count,
            "file"
          )} successfully (evm ${(0, strings_1.pluralize)(
...
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY)
  ...
  .setAction(({ force, quiet, concurrency }, { artifacts, config, run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const rootPath = config.paths.root;
      const sourcePaths = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_PATHS,
        { sourcePath: config.paths.sources }
      );
      const sourceNames = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_GET_SOURCE_NAMES,
        {
          rootPath,
          sourcePaths,
        }
      );
      const solidityFilesCachePath = (0,
      solidity_files_cache_1.getSolidityFilesCachePath)(config.paths);
      let solidityFilesCache =
        yield solidity_files_cache_1.SolidityFilesCache.readFromFile(
          solidityFilesCachePath
        );
      const dependencyGraph = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_GET_DEPENDENCY_GRAPH,
        { rootPath, sourceNames, solidityFilesCache }
      );
      solidityFilesCache = yield invalidateCacheMissingArtifacts(
        solidityFilesCache,
        artifacts,
        dependencyGraph.getResolvedFiles()
      );
      const compilationJobsCreationResult = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_GET_COMPILATION_JOBS,
        {
          dependencyGraph,
          solidityFilesCache,
      ...
      const filteredCompilationJobs = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_FILTER_COMPILATION_JOBS,
        { compilationJobs, force, solidityFilesCache }
      );
      const mergedCompilationJobs = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_MERGE_COMPILATION_JOBS,
        { compilationJobs: filteredCompilationJobs }
      );
      const { artifactsEmittedPerJob } = yield run(
        task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_JOBS,
        {
      ...
      yield solidityFilesCache.writeToFile(solidityFilesCachePath);
      yield run(task_names_1.TASK_COMPILE_SOLIDITY_LOG_COMPILATION_RESULT, {
        compilationJobs: mergedCompilationJobs,
        quiet,
      });
    })
...
(0, config_env_1.subtask)(
  task_names_1.TASK_COMPILE_REMOVE_OBSOLETE_ARTIFACTS,
  (_, { artifacts }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // We know this is the actual implementation, so we use some
      // non-public methods here.
      const artifactsImpl = artifacts;
      yield artifactsImpl.removeObsoleteArtifacts();
    })
);
/**
 ...
 */
(0, config_env_1.subtask)(task_names_1.TASK_COMPILE_GET_COMPILATION_TASKS, () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
(0, config_env_1.task)(
  ...
  .setAction((compilationArgs, { run }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const compilationTasks = yield run(
        task_names_1.TASK_COMPILE_GET_COMPILATION_TASKS
      );
      for (const compilationTask of compilationTasks) {
        yield run(compilationTask, compilationArgs);
      }
      yield run(task_names_1.TASK_COMPILE_REMOVE_OBSOLETE_ARTIFACTS);
    })
  );
/**
...
function invalidateCacheMissingArtifacts(
  ...
  return __awaiter(this, void 0, void 0, function* () {
    const paths = new Set(yield artifacts.getArtifactPaths());
    for (const file of resolvedFiles) {
      ...
      for (const emittedArtifact of emittedArtifacts) {
        const fqn = (0, contract_names_1.getFullyQualifiedName)(
          file.sourceName,
          emittedArtifact
        );
...
function hasCompilationErrors(output) {
  var _a;
  return (_a = output.errors) === null || _a === void 0
    ? void 0
    : _a.some((x) => x.severity === "error");
}
/**
