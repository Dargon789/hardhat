...
class ArgumentsParser {
  ...
  _addHardhatDefaultArguments(
    hardhatParamDefinitions,
    envVariableArguments,
    hardhatArguments
  ) {
    return Object.assign(
      Object.assign({}, envVariableArguments),
      hardhatArguments
    );
  }
      ...
      if (value === undefined) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.ARGUMENTS.MISSING_TASK_ARGUMENT,
          {
            param: ArgumentsParser.paramNameToCLA(paramName),
            task:
              scopeOrTaskName !== null && scopeOrTaskName !== void 0
                ? scopeOrTaskName
                : "help",
          }
        );
