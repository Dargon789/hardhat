...
class Analytics {
  static getInstance(telemetryConsent) {
   ...
   */
  sendTaskHit(scopeName, taskName) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this._enabled) {
      ...
      return this._sendHit(yield this._buildTaskHitPayload(eventParams));
    });
  }
  sendTelemetryConsentHit(userConsent) {
    return __awaiter(this, void 0, void 0, function* () {
  ...
  _buildTaskHitPayload(eventParams = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      return {
        ...
        user_properties: {
          ...
          hardhatVersion: { value: yield getHardhatVersion() },
...
function getClientId() {
  var _a;
  return __awaiter(this, void 0, void 0, function* () {
    let clientId = yield (0, global_dir_1.readAnalyticsId)();
    if (clientId === undefined) {
      clientId =
        (_a = yield (0, global_dir_1.readSecondLegacyAnalyticsId)()) !== null &&
        _a !== void 0
          ? _a
          : yield (0, global_dir_1.readFirstLegacyAnalyticsId)();
      if (clientId === undefined) {
        const { v4: uuid } = yield Promise.resolve().then(() =>
          __importStar(require("uuid"))
        );
        log("Client Id not found, generating a new one");
        clientId = uuid();
      }
      yield (0, global_dir_1.writeAnalyticsId)(clientId);
    }
    return clientId;
  });
}
...
function getHardhatVersion() {
  return __awaiter(this, void 0, void 0, function* () {
    const { version } = yield (0, packageInfo_1.getPackageJson)();
    return `Hardhat ${version}`;
  });
}
function requestTelemetryConsent() {
  return __awaiter(this, void 0, void 0, function* () {
    const telemetryConsent = yield (0, prompt_1.confirmTelemetryConsent)();
    if (telemetryConsent === undefined) {
      return;
    }
    (0, global_dir_1.writeTelemetryConsent)(telemetryConsent);
    const reportTelemetryConsentPath = (0, node_path_1.join)(
      __dirname,
      "..",
      "util",
      "report-telemetry-consent.js"
    );
    const subprocess = (0, node_child_process_1.spawn)(
      process.execPath,
