...
exports.complete =
  exports.REQUIRED_HH_VERSION_RANGE =
  exports.HARDHAT_COMPLETE_FILES =
    void 0;
...
function complete({ line, point }) {
  var _a;
  return __awaiter(this, void 0, void 0, function* () {
    const completionData = yield getCompletionData();
    ...
    if (prev.startsWith("-")) {
      ...
      const isTaskParam =
        ((_a =
          taskDefinition === null || taskDefinition === void 0
            ? void 0
            : taskDefinition.paramDefinitions[paramName]) === null ||
        _a === void 0
          ? void 0
          : _a.isFlag) === false;
      if (isTaskParam) {
    ...
    const taskParams =
      taskDefinition === undefined
        ...
        : Object.values(taskDefinition.paramDefinitions)
            .map((param) => ({
              name: ArgumentsParser_1.ArgumentsParser.paramNameToCLA(
                param.name
              ),
...
function getCompletionData() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const cachedCompletionData = yield getCachedCompletionData(projectId);
    ...
    const scopes = (0, lang_1.mapValues)(hre.scopes, (scope) => {
      ...
      return {
        name: scope.name,
        description:
          (_a = scope.description) !== null && _a !== void 0 ? _a : "",
        tasks: (0, lang_1.mapValues)(scope.tasks, (task) =>
          getTaskFromTaskDefinition(task)
        ),
      };
    });
    ...
    yield saveCachedCompletionData(projectId, completionData, mtimes);
...
function getTaskFromTaskDefinition(taskDef) {
  ...
  return {
    name: taskDef.name,
    description: (_a = taskDef.description) !== null && _a !== void 0 ? _a : "",
    isSubtask: taskDef.isSubtask,
    paramDefinitions: (0, lang_1.mapValues)(
      ...
      (paramDefinition) => {
        ...
        return {
          ...
          description:
            (_a = paramDefinition.description) !== null && _a !== void 0
              ? _a
              : "",
...
function getCachedCompletionData(projectId) {
  return __awaiter(this, void 0, void 0, function* () {
    const cachedCompletionDataPath = yield getCachedCompletionDataPath(
      projectId
    );
...
function saveCachedCompletionData(projectId, completionData, mtimes) {
  return __awaiter(this, void 0, void 0, function* () {
    const cachedCompletionDataPath = yield getCachedCompletionDataPath(
      projectId
    );
    yield fs.outputJson(cachedCompletionDataPath, { completionData, mtimes });
  });
}
function getCachedCompletionDataPath(projectId) {
  return __awaiter(this, void 0, void 0, function* () {
    const cacheDir = yield (0, global_dir_1.getCacheDir)();
...
function isGlobalFlag(param) {
  ...
  return (
    ((_a = hardhat_params_1.HARDHAT_PARAM_DEFINITIONS[paramName]) === null ||
    _a === void 0
      ? void 0
      : _a.isFlag) === true
  );
