...
class BannerManager {
  ...
  _requestBannerConfig(timeout) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const bannerConfig = yield (0, request_1.requestJson)(
          BANNER_CONFIG_URL,
          timeout
        );
  ...
  showBanner(timeout) {
    return __awaiter(this, void 0, void 0, function* () {
      yield this._requestBannerConfig(timeout);
      if (
      ...
      const { formattedMessages, minSecondsBetweenDisplays } =
        this._bannerConfig;
...
function readCache() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const bannerCacheFilePath = node_path_1.default.join(
      cacheDir,
    ...
    try {
      const fileContents = yield promises_1.default.readFile(
        bannerCacheFilePath,
        "utf-8"
      );
