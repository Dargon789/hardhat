...
exports.installHardhatVSCode =
  exports.isHardhatVSCodeInstalled =
  exports.InstallationState =
    void 0;
const child_process_1 = require("child_process");
var InstallationState;
(function (InstallationState) {
  InstallationState[(InstallationState["VSCODE_FAILED_OR_NOT_INSTALLED"] = 0)] =
    "VSCODE_FAILED_OR_NOT_INSTALLED";
  InstallationState[(InstallationState["EXTENSION_INSTALLED"] = 1)] =
    "EXTENSION_INSTALLED";
  InstallationState[(InstallationState["EXTENSION_NOT_INSTALLED"] = 2)] =
    "EXTENSION_NOT_INSTALLED";
})(
  (InstallationState =
    exports.InstallationState || (exports.InstallationState = {}))
);
const HARDHAT_VSCODE_ID = "NomicFoundation.hardhat-solidity";
function isHardhatVSCodeInstalled() {
  try {
    const { stdout, status } = (0, child_process_1.spawnSync)(
      "code",
      ["--list-extensions"],
      {
        encoding: "utf8",
...
function installHardhatVSCode() {
  try {
    const { status } = (0, child_process_1.spawnSync)(
      "code",
