...
function showNewVersionNotification() {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const sortedV2Versions = releases
      ...
      .flatMap((release) => {
        ...
        if (
          ...
          release.prerelease ||
          packageVersion === null ||
          semver_1.default.major(packageVersion) !==
            CURRENT_HARDHAT_MAJOR_VERSION
        ) {
          return [];
        }
    ...
    const v3Release =
      (_a = cache.v3Release) !== null && _a !== void 0
        ? _a
        : yield getV3Release();
    ...
    if (
      ...
      if (yield fs_extra_1.default.pathExists("yarn.lock")) {
        installationCommand = "yarn add";
      } else if (yield fs_extra_1.default.pathExists("pnpm-lock.yaml")) {
        installationCommand = "pnpm install";
      }
      console.log(
        (0, boxen_1.default)(
          `New Hardhat release available! ${picocolors_1.default.red(
            hardhatVersion
          )} -> ${picocolors_1.default.green(latestV2Version)}.
...
Run "${installationCommand} hardhat@latest" to update.`,
    ...
    if (
      ...
      const releaseVersion = semver_1.default.valid(
        v3Release.tag_name.split("@")[1]
      );
      if (releaseVersion !== null) {
        (_b = cache.v3ReleaseMessage) !== null && _b !== void 0
          ? _b
          : (cache.v3ReleaseMessage = yield getV3ReleaseMessage(v3Release));
        if (cache.v3ReleaseMessage !== undefined) {
          console.log(
            (0, boxen_1.default)(cache.v3ReleaseMessage, boxenOptions)
          );
          cache.v3TimesShown++;
        }
      }
...
function readCache() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const versionNotifierCachePath = (0, node_path_1.join)(
      cacheDir,
      "version-notifier.json"
    );
    let cache = {
      lastCheck: 0,
      v3TimesShown: 0,
    ...
    try {
      const fileContents = yield (0, promises_1.readFile)(
...
function writeCache(cache) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      yield (0,
      promises_1.writeFile)(versionNotifierCachePath, JSON.stringify(cache, null, 2));
    } catch (error) {
      // We don't care if it fails
    }
  });
...
function getReleases() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    let releases = [];
    try {
      const githubResponse = yield request(
      ...
      releases = yield githubResponse.body.json();
    } catch (error) {
      // We don't care if it fails
    }
    return releases;
...
function getV3Release() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      const jsonResponse = yield githubResponse.body.json();
...
function getV3ReleaseMessage(v3Release) {
  return __awaiter(this, void 0, void 0, function* () {
    const { request } = yield Promise.resolve().then(() =>
      __importStar(require("undici"))
    );
    ...
    try {
      ...
      v3ReleaseMessage = yield githubResponse.body.text();
    } catch (error) {
      // We don't care if it fails
    }
