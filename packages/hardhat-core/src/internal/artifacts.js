...
class Artifacts {
  ...
  readArtifact(name) {
    return __awaiter(this, void 0, void 0, function* () {
      const artifactPath = yield this._getArtifactPath(name);
  ...
  artifactExists(name) {
    return __awaiter(this, void 0, void 0, function* () {
      let artifactPath;
      try {
        artifactPath = yield this._getArtifactPath(name);
      } catch (e) {
  ...
  getAllFullyQualifiedNames() {
    return __awaiter(this, void 0, void 0, function* () {
      const paths = yield this.getArtifactPaths();
      return paths.map((p) => this._getFullyQualifiedNameFromPath(p)).sort();
    });
  }
  getBuildInfo(fullyQualifiedName) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
      let buildInfoPath =
        (_a = this._cache) === null || _a === void 0
          ? void 0
          : _a.artifactFQNToBuildInfoPathCache.get(fullyQualifiedName);
      if (buildInfoPath === undefined) {
        const artifactPath =
          this.formArtifactPathFromFullyQualifiedName(fullyQualifiedName);
        const debugFilePath = this._getDebugFilePath(artifactPath);
        buildInfoPath = yield this._getBuildInfoFromDebugFile(debugFilePath);
        if (buildInfoPath === undefined) {
          return undefined;
        }
        (_b = this._cache) === null || _b === void 0
          ? void 0
          : _b.artifactFQNToBuildInfoPathCache.set(
              fullyQualifiedName,
              buildInfoPath
            );
      }
  ...
  getArtifactPaths() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const paths = yield (0, fs_utils_1.getAllFilesMatching)(
        this._artifactsPath,
        (f) => this._isArtifactPath(f)
      );
  ...
  getBuildInfoPaths() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const paths = yield (0, fs_utils_1.getAllFilesMatching)(
        path.join(this._artifactsPath, constants_1.BUILD_INFO_DIR_NAME),
        (f) => f.endsWith(".json")
      );
      const result = paths.sort();
      if (this._cache !== undefined) {
  ...
  saveArtifactAndDebugFile(artifact, pathToBuildInfo) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        // artifact
        const fullyQualifiedName = (0, contract_names_1.getFullyQualifiedName)(
          artifact.sourceName,
          artifact.contractName
        );
        const artifactPath =
          this.formArtifactPathFromFullyQualifiedName(fullyQualifiedName);
        yield fs_extra_1.default.ensureDir(path.dirname(artifactPath));
        yield Promise.all([
          ...
          (() =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              yield fs_extra_1.default.writeJSON(debugFilePath, debugFile, {
                spaces: 2,
              });
            }))(),
        ]);
  ...
  saveBuildInfo(solcVersion, solcLongVersion, input, output) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield fs_extra_1.default.ensureDir(buildInfoDir);
        ...
        // by the GC if needed.
        const file = yield promises_1.default.open(buildInfoPath, "w");
        try {
          {
            const withoutOutput = JSON.stringify(
              Object.assign(Object.assign({}, buildInfo), { output: undefined })
            );
            // We write the JSON (without output) except the last }
            yield file.write(withoutOutput.slice(0, -1));
          }
          {
            const outputWithoutSourcesAndContracts = JSON.stringify(
              Object.assign(Object.assign({}, buildInfo.output), {
                sources: undefined,
                contracts: undefined,
              })
            );
            // We start writing the output
            yield file.write(',"output":');
            // Write the output object except for the last }
            yield file.write(outputWithoutSourcesAndContracts.slice(0, -1));
          ...
          // Writing the sources
          yield file.write('"sources":{');
          let isFirst = true;
          for (const [name, value] of Object.entries(
            (_a = buildInfo.output.sources) !== null && _a !== void 0 ? _a : {}
          )) {
            if (isFirst) {
              isFirst = false;
            } else {
          ...
          yield file.write(',"contracts":{');
          isFirst = true;
          for (const [name, value] of Object.entries(
            (_b = buildInfo.output.contracts) !== null && _b !== void 0
              ? _b
              : {}
          )) {
            if (isFirst) {
  ...
  removeObsoleteArtifacts() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const existingArtifactsPaths = yield this.getArtifactPaths();
        yield Promise.all(
        ...
        yield this._removeObsoleteBuildInfos();
      } finally {
  ...
  formArtifactPathFromFullyQualifiedName(fullyQualifiedName) {
    const { sourceName, contractName } = (0,
   ...
   */
  _removeObsoleteBuildInfos() {
    return __awaiter(this, void 0, void 0, function* () {
      const debugFiles = yield this.getDebugFilePaths();
      const buildInfos = yield Promise.all(
        debugFiles.map((debugFile) =>
          __awaiter(this, void 0, void 0, function* () {
            const buildInfoFile = yield this._getBuildInfoFromDebugFile(
              debugFile
            );
      ...
      const filteredBuildInfos = buildInfos.filter(
        (bf) => typeof bf === "string"
      );
      const validBuildInfos = new Set(filteredBuildInfos);
      const buildInfoFiles = yield this.getBuildInfoPaths();
      yield Promise.all(
        buildInfoFiles
          ...
          .map((buildInfoFile) =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              yield fs_extra_1.default.unlink(buildInfoFile);
            })
          )
      );
    });
  ...
  _getBuildInfoName(solcVersion, solcLongVersion, input) {
    ...
    return (0, hash_1.createNonCryptographicHashBasedIdentifier)(
      Buffer.from(json)
    ).toString("hex");
  }
  /**
   ...
   */
  _getArtifactPath(name) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
      const cached =
        (_a = this._cache) === null || _a === void 0
          ? void 0
          : _a.artifactNameToArtifactPathCache.get(name);
      if (cached !== undefined) {
        return cached;
      }
      let result;
      if ((0, contract_names_1.isFullyQualifiedName)(name)) {
        result = yield this._getValidArtifactPathFromFullyQualifiedName(name);
      } else {
        const files = yield this.getArtifactPaths();
        result = this._getArtifactPathFromFiles(name, files);
      }
      (_b = this._cache) === null || _b === void 0
        ? void 0
        : _b.artifactNameToArtifactPathCache.set(name, result);
      return result;
    });
  }
  ...
  _getArtifactPathsSync() {
    var _a;
    const cached =
      (_a = this._cache) === null || _a === void 0 ? void 0 : _a.artifactPaths;
    if (cached !== undefined) {
      return cached;
    }
    const paths = (0, fs_utils_1.getAllFilesMatchingSync)(
      this._artifactsPath,
      (f) => this._isArtifactPath(f)
    );
    const result = paths.sort();
   ...
   * - {@link ERRORS.ARTIFACTS.NOT_FOUND} If the artifact is not found.
   */
  _getValidArtifactPathFromFullyQualifiedName(fullyQualifiedName) {
    return __awaiter(this, void 0, void 0, function* () {
      const artifactPath =
        this.formArtifactPathFromFullyQualifiedName(fullyQualifiedName);
      try {
        const trueCasePath = path.join(
          this._artifactsPath,
          yield (0, fs_utils_1.getFileTrueCase)(
            this._artifactsPath,
        ...
        if (artifactPath !== trueCasePath) {
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.ARTIFACTS.WRONG_CASING,
            {
...
`;
  ...
  _getValidArtifactPathFromFullyQualifiedNameSync(fullyQualifiedName) {
    ...
    try {
      const trueCasePath = path.join(
        this._artifactsPath,
        (0, fs_utils_1.getFileTrueCaseSync)(
          this._artifactsPath,
          path.relative(this._artifactsPath, artifactPath)
        )
      );
  ...
  _getArtifactPathFromFiles(contractName, files) {
    ...
    if (matchingFiles.length > 1) {
      ...
      throw new errors_1.HardhatError(
        errors_list_1.ERRORS.ARTIFACTS.MULTIPLE_FOUND,
        {
          contractName,
   ...
   */
  _removeArtifactFiles(artifactPath) {
    return __awaiter(this, void 0, void 0, function* () {
      yield fs_extra_1.default.remove(artifactPath);
      const debugFilePath = this._getDebugFilePath(artifactPath);
      yield fs_extra_1.default.remove(debugFilePath);
    });
  }
  /**
   ...
   */
  _getBuildInfoFromDebugFile(debugFilePath) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getArtifactFromContractOutput(
  ...
  const evmBytecode =
    (_a = contractOutput.evm) === null || _a === void 0 ? void 0 : _a.bytecode;
  let bytecode =
    (_b =
      evmBytecode === null || evmBytecode === void 0
        ? void 0
        : evmBytecode.object) !== null && _b !== void 0
      ? _b
      : "";
  ...
  const evmDeployedBytecode =
    (_c = contractOutput.evm) === null || _c === void 0
      ? void 0
      : _c.deployedBytecode;
  let deployedBytecode =
    (_d =
      evmDeployedBytecode === null || evmDeployedBytecode === void 0
        ? void 0
        : evmDeployedBytecode.object) !== null && _d !== void 0
      ? _d
      : "";
  ...
  const linkReferences =
    (_e =
      evmBytecode === null || evmBytecode === void 0
        ? void 0
        : evmBytecode.linkReferences) !== null && _e !== void 0
      ? _e
      : {};
  const deployedLinkReferences =
    (_f =
      evmDeployedBytecode === null || evmDeployedBytecode === void 0
        ? void 0
        : evmDeployedBytecode.linkReferences) !== null && _f !== void 0
      ? _f
      : {};
  return {
