...
exports.vars =
  exports.extendProvider =
  exports.extendConfig =
  exports.extendEnvironment =
  exports.types =
  exports.scope =
  exports.internalTask =
  exports.subtask =
  exports.task =
    void 0;
...
function hasVar(varName) {
  ...
  return context_1.HardhatContext.getHardhatContext().varsManager.has(
    varName,
    true
  );
}
...
function getVar(varName, defaultValue) {
  // varsManager will be an instance of VarsManager or VarsManagerSetup depending on the context (vars setup mode or not)
  const value = context_1.HardhatContext.getHardhatContext().varsManager.get(
    varName,
    defaultValue,
    true
  );
  ...
  throw new errors_1.HardhatError(
    errors_list_1.ERRORS.VARS.VALUE_NOT_FOUND_FOR_VAR,
    {
      value: varName,
    }
  );
