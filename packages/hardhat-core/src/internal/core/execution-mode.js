...
exports.isRunningHardhatCoreTests =
  exports.isLocalDev =
  exports.isHardhatInstalledLocallyOrLinked =
    void 0;
...
function isHardhatInstalledLocallyOrLinked(configPath) {
  try {
    const resolvedPackageJson = require.resolve("hardhat/package.json", {
      paths: [
        configPath !== null && configPath !== void 0
          ? configPath
          : process.cwd(),
      ],
    });
    ...
    return (
      (0, fs_utils_1.getRealPathSync)(resolvedPackageJson) ===
      (0, fs_utils_1.getRealPathSync)(thisPackageJson)
    );
  } catch (_a) {
    return false;
  }
