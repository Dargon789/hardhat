...
exports.isJavascriptFile =
  exports.isTypescriptFile =
  exports.loadTsNode =
  exports.isTypescriptSupported =
  exports.isRunningWithTypescript =
  exports.willRunWithTypescript =
    void 0;
...
function loadTsNode(tsConfigPath, shouldTypecheck = false) {
  try {
    ...
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.GENERAL.TYPESCRIPT_NOT_INSTALLED
    );
  }
  try {
    require.resolve("ts-node");
    ...
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.GENERAL.TS_NODE_NOT_INSTALLED
    );
  }
