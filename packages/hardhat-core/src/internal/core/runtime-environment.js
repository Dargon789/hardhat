...
class Environment {
  ...
  constructor(
    ...
    this.run = (
      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (scope === undefined) {
          ...
          if (scopeDefinition === undefined) {
            throw new errors_1.HardhatError(
              errors_list_1.ERRORS.ARGUMENTS.UNRECOGNIZED_SCOPE,
              {
                scope,
              }
            );
          ...
          taskDefinition =
            (_a = scopeDefinition.tasks) === null || _a === void 0
              ? void 0
              : _a[task];
        ...
        try {
          return yield this._runTaskDefinition(
            taskDefinition,
    ...
    const provider =
      new lazy_initialization_1.LazyInitializationProviderAdapter(() =>
        __awaiter(this, void 0, void 0, function* () {
          log(`Creating provider for network ${networkName}`);
          return (0,
          construction_1.createProvider)(config, networkName, this.artifacts, providerExtenders);
        })
      );
    this.network = {
      name: networkName,
  ...
  _runTaskDefinition(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        taskDefinition instanceof task_definitions_1.OverriddenTaskDefinition
      ) {
        runSuperFunction = (
        ...
        runSuperFunction = () =>
          __awaiter(this, void 0, void 0, function* () {
            throw new errors_1.HardhatError(
              errors_list_1.ERRORS.TASK_DEFINITIONS.RUNSUPER_NOT_AVAILABLE,
              {
      ...
      const proxiedHre = new Proxy(this, {
        get(target, p, receiver) {
          if (p === "run") {
            return (_name, _taskArguments, _subtaskArguments) =>
              target.run(
                _name,
                _taskArguments,
                Object.assign(
                  Object.assign({}, _subtaskArguments),
                  subtaskArguments
      ...
      if (this.hardhatArguments.flamegraph === true) {
        ...
        proxiedHre.adhocProfile = (_name, f) =>
          __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        return yield taskDefinition.action(taskArguments, proxiedHre, runSuper);
      } finally {
        uninjectFromGlobal();
  ...
  _resolveValidTaskArguments(taskDefinition, taskArguments, subtaskArguments) {
    ...
    for (const paramDefinition of allTaskParamDefinitions) {
      ...
      const argumentValue =
        (_b =
          (_a = subtaskArguments[taskName]) === null || _a === void 0
            ? void 0
            : _a[paramName]) !== null && _b !== void 0
          ? _b
          : taskArguments[paramName];
    ...
    return Object.assign(Object.assign({}, taskArguments), resolvedArguments);
  }
  /**
