...
exports.normalizeHardhatNetworkAccountsConfig = exports.derivePrivateKeys =
  void 0;
...
function derivePrivateKeys(mnemonic, hdpath, initialIndex, count, passphrase) {
  ...
  for (let i = initialIndex; i < initialIndex + count; i++) {
    const privateKey = (0, keys_derivation_1.deriveKeyFromMnemonicAndPath)(
      mnemonic,
      hdpath + i.toString(),
      passphrase
    );
    if (privateKey === undefined) {
      throw new errors_1.HardhatError(
        errors_list_1.ERRORS.NETWORK.CANT_DERIVE_KEY,
        {
          mnemonic,
          path: hdpath,
        }
...
function normalizeHardhatNetworkAccountsConfig(accountsConfig) {
  ...
  return derivePrivateKeys(
    ...
    return {
      ...
      balance:
        (_a = accountsConfig.accountsBalance) !== null && _a !== void 0
          ? _a
          : default_config_1.DEFAULT_HARDHAT_NETWORK_BALANCE,
    };
  });
}
exports.normalizeHardhatNetworkAccountsConfig =
