...
exports.optionalStateOverrideSet =
  exports.stateOverrideSet =
  exports.stateOverrideOptions =
  exports.stateProperties =
  exports.rpcCallRequest =
    void 0;
...
exports.rpcCallRequest = t.type(
  {
    ...
    maxPriorityFeePerGas: (0, io_ts_1.optionalOrNullable)(
      base_types_1.rpcQuantity
    ),
    blobs: (0, io_ts_1.optionalOrNullable)(t.array(base_types_1.rpcData)),
    blobVersionedHashes: (0, io_ts_1.optionalOrNullable)(
      t.array(base_types_1.rpcHash)
    ),
  },
  "RpcCallRequest"
);
// Types used by eth_call to configure the state override set
exports.stateProperties = t.record(
  base_types_1.rpcStorageSlotHexString,
  base_types_1.rpcStorageSlot
);
...
exports.stateOverrideSet = t.record(
  config_validation_1.address,
  exports.stateOverrideOptions
);
exports.optionalStateOverrideSet = (0, io_ts_1.optionalOrNullable)(
  exports.stateOverrideSet
);
