...
exports.rpcDataToBuffer =
  exports.bufferToRpcData =
  exports.rpcDataToBigInt =
  exports.rpcDataToNumber =
  exports.numberToRpcStorageSlot =
  exports.numberToRpcQuantity =
  exports.rpcQuantityToBigInt =
  exports.rpcQuantityToNumber =
  exports.rpcFloat =
  exports.rpcQuantityAsNumber =
  exports.rpcUnsignedInteger =
  exports.rpcAddress =
  exports.rpcStorageSlotHexString =
  exports.rpcStorageSlot =
  exports.rpcHash =
  exports.rpcParity =
  exports.rpcData =
  exports.rpcQuantity =
...
exports.rpcHash = new t.Type(
  "HASH",
  (v) => Buffer.isBuffer(v) && v.length === HASH_LENGTH_BYTES,
  (u, c) =>
    isRpcHashString(u)
      ? t.success(Buffer.from((0, util_1.toBytes)(u)))
      : t.failure(u, c),
...
exports.rpcStorageSlot = new t.Type(
  "Storage slot",
  BigIntUtils.isBigInt,
  validateStorageSlot,
  t.identity
...
exports.rpcStorageSlotHexString = new t.Type(
...
exports.rpcAddress = new t.Type(
  "ADDRESS",
  (v) => Buffer.isBuffer(v) && v.length === ADDRESS_LENGTH_BYTES,
  (u, c) =>
...
exports.rpcUnsignedInteger = new t.Type(
  "Unsigned integer",
  isInteger,
  (u, c) => (isInteger(u) && u >= 0 ? t.success(u) : t.failure(u, c)),
  t.identity
);
exports.rpcQuantityAsNumber = new t.Type(
  "Integer",
  BigIntUtils.isBigInt,
  (u, c) => (isInteger(u) ? t.success(BigInt(u)) : t.failure(u, c)),
  t.identity
);
exports.rpcFloat = new t.Type(
  "Float number",
  isNumber,
...
function rpcQuantityToBigInt(quantity) {
  ...
  if (!isRpcQuantityString(quantity)) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.NETWORK.INVALID_RPC_QUANTITY_VALUE,
      {
        value: quantity,
      }
    );
...
function rpcDataToBuffer(data) {
  ...
  if (!isRpcDataString(data)) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.NETWORK.INVALID_RPC_DATA_VALUE,
      {
        value: data,
      }
    );
