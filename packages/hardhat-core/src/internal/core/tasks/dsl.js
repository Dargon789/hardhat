...
class TasksDSL {
  ...
  scope(name, description) {
    ...
    const scope = new task_definitions_1.SimpleScopeDefinition(
      name,
      description,
  ...
  getTaskDefinition(scope, name) {
    ...
    if (scope === undefined) {
      ...
      return (_b =
        (_a = this._scopes[scope]) === null || _a === void 0
          ? void 0
          : _a.tasks) === null || _b === void 0
        ? void 0
        : _b[name];
    }
  }
  _addTask(taskIdentifier, descriptionOrAction, action, isSubtask) {
    ...
    if (parentTaskDefinition !== undefined) {
      taskDefinition = new task_definitions_1.OverriddenTaskDefinition(
