...
exports.saveFlamegraph =
  exports.createFlamegraphHtmlFile =
  exports.profileToFlamegraph =
    void 0;
...
exports.profileToFlamegraph = profileToFlamegraph;
/**
 ...
 **/
function foldFramegraph(toFold) {
...
function createFlamegraphHtmlFile(flamegraph) {
  const content = getFlamegraphFileContent(foldFramegraph(flamegraph));
  const path = "flamegraph.html";
  fs_1.default.writeFileSync(path, content, { encoding: "utf8" });
  return path;
}
exports.createFlamegraphHtmlFile = createFlamegraphHtmlFile;
function getFlamegraphFileContent(flamegraph) {
 ...
 */
function saveFlamegraph(profile) {
  (0, task_profiling_1.flagParallelChildren)(profile);
