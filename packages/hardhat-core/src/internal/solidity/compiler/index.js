...
class Compiler {
  ...
  compile(input) {
    return __awaiter(this, void 0, void 0, function* () {
      const scriptPath = node_path_1.default.join(
        __dirname,
        "./solcjs-runner.js"
      );
      const output = yield new Promise((resolve, reject) => {
        try {
          const subprocess = (0, child_process_1.execFile)(
            process.execPath,
          ...
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.SOLC.SOLCJS_ERROR,
            { error: e.message },
            e
          );
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this._solcVersion !== undefined) {
        if (semver.gte(this._solcVersion, "0.8.22")) {
          ...
          // version >= 0.6.9
          const tmpFolder = node_path_1.default.join(
      ...
      const output = yield new Promise((resolve, reject) => {
        try {
          const process = (0, child_process_1.execFile)(
            this._pathToSolc,
            args,
            {
              maxBuffer: 1024 * 1024 * 500,
          ...
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.SOLC.CANT_RUN_NATIVE_COMPILER,
            {},
            e
          );
        }
