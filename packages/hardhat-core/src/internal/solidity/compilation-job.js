...
exports.mergeCompilationJobsWithoutBug =
  exports.mergeCompilationJobsWithBug =
  exports.createCompilationJobFromFile =
  exports.createCompilationJobsFromConnectedComponent =
  exports.CompilationJob =
    void 0;
...
class CompilationJob {
  ...
  hasSolc9573Bug() {
    ...
    return (
      ((_c =
        (_b =
          (_a = this.solidityConfig) === null || _a === void 0
            ? void 0
            : _a.settings) === null || _b === void 0
          ? void 0
          : _b.optimizer) === null || _c === void 0
        ? void 0
        : _c.enabled) === true &&
      semver_1.default.satisfies(
        this.solidityConfig.version,
        SOLC_BUG_9573_VERSIONS
      )
    );
  }
  merge(job) {
 ...
 */
function createCompilationJobsFromConnectedComponent(
  connectedComponent,
  getFromFile
) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const file of connectedComponent.getResolvedFiles()) {
      const compilationJobOrError = yield getFromFile(file);
...
function createCompilationJobFromFile(dependencyGraph, file, solidityConfig) {
  return __awaiter(this, void 0, void 0, function* () {
...
function getCompilerConfigForFile(
  ...
  const overrides =
    (_a = solidityConfig.overrides) !== null && _a !== void 0 ? _a : {};
  ...
  const matchingVersion = semver_1.default.maxSatisfying(
    compilerVersions,
    versionRange
  );
...
function getCompilationJobCreationError(
  ...
  if (
    semver_1.default.maxSatisfying(compilerVersions, fileVersionRange) === null
  ) {
  ...
  for (const dependency of directDependencies) {
    ...
    if (
      !semver_1.default.intersects(fileVersionRange, dependencyVersionRange)
    ) {
