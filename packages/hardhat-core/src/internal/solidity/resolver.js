...
class Resolver {
  ...
  resolveSourceName(sourceName) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const remappedSourceName = (0, remappings_1.applyRemappings)(
        this._remappings,
        sourceName
      );
      ...
      if (
        ...
        resolvedFile = yield this._resolveLocalSourceName(
          sourceName,
          remappedSourceName
        );
      } else {
        resolvedFile = yield this._resolveLibrarySourceName(
          sourceName,
          remappedSourceName
        );
      }
   ...
   */
  resolveImport(from, importName) {
    return __awaiter(this, void 0, void 0, function* () {
      // sanity check for deprecated task
      if (importName !== (yield this._transformImportName(importName))) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.TASK_DEFINITIONS.DEPRECATED_TRANSFORM_IMPORT_TASK
        );
      }
      const imported = (0, remappings_1.applyRemappings)(
        this._remappings,
        importName
      );
      ...
      if (scheme !== undefined) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_PROTOCOL,
          {
      ...
      if ((0, source_names_1.replaceBackslashes)(imported) !== imported) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_BACKSLASH,
          {
            from: from.sourceName,
            imported,
          }
      ...
      if ((0, source_names_1.isAbsolutePathSourceName)(imported)) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_ABSOLUTE_PATH,
          {
            from: from.sourceName,
            imported,
          }
      ...
      if (yield (0, source_names_1.includesOwnPackageName)(imported)) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.INCLUDES_OWN_PACKAGE_NAME,
          {
            from: from.sourceName,
            imported,
          }
      ...
      try {
        ...
        if (isRelativeImport) {
          sourceName = yield this._relativeImportToSourceName(from, imported);
        } else {
        ...
        if (
          ...
          resolvedFile = yield this._resolveLocalSourceName(
            sourceName,
            (0, remappings_1.applyRemappings)(this._remappings, sourceName)
          );
        } else {
          resolvedFile = yield this.resolveSourceName(sourceName);
        }
        this._cache.set(sourceName, resolvedFile);
        return resolvedFile;
      } catch (error) {
        if (
          ...
          if (imported !== importName) {
            throw new errors_1.HardhatError(
              errors_list_1.ERRORS.RESOLVER.IMPORTED_MAPPED_FILE_NOT_FOUND,
              {
                imported,
                importName,
                from: from.sourceName,
        ...
        if (
          ...
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_WRONG_CASING,
            {
              imported,
              from: from.sourceName,
            },
        ...
        if (
          ...
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.RESOLVER.IMPORTED_LIBRARY_NOT_INSTALLED,
            {
  ...
  _resolveLocalSourceName(sourceName, remappedSourceName) {
    return __awaiter(this, void 0, void 0, function* () {
      yield this._validateSourceNameExistenceAndCasing(
        this._projectRoot,
        remappedSourceName,
        false
      );
      const absolutePath = path_1.default.join(
        this._projectRoot,
        remappedSourceName
      );
  ...
  _resolveLibrarySourceName(sourceName, remappedSourceName) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        packageJsonPath = this._resolveNodeModulesFileFromProjectRoot(
          path_1.default.join(libraryName, "package.json")
        );
      } catch (error) {
      ...
      let nodeModulesPath = path_1.default.dirname(
      ...
      if (path_1.default.basename(nodeModulesPath) !== NODE_MODULES) {
        ...
        absolutePath = path_1.default.join(
          nodeModulesPath,
          normalizedSourceName
        );
      }
      const packageInfo = yield fs_extra_1.default.readJson(packageJsonPath);
      ...
      return this._resolveFile(
        ...
        yield (0, fs_utils_1.getRealPath)(absolutePath),
        libraryName,
        libraryVersion
      );
    });
  }
  _relativeImportToSourceName(from, imported) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const sourceName = (0, source_names_1.normalizeSourceName)(
        path_1.default.join(path_1.default.dirname(from.sourceName), imported)
      );
      ...
      if (from.library === undefined && sourceName.startsWith("../")) {
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_OUTSIDE_OF_PROJECT,
      ...
      if (
        ...
        throw new errors_1.HardhatError(
          errors_list_1.ERRORS.RESOLVER.ILLEGAL_IMPORT,
          {
            from: from.sourceName,
            imported,
          }
  ...
  _resolveFile(sourceName, absolutePath, libraryName, libraryVersion) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const contentHash = (0, hash_1.createNonCryptographicHashBasedIdentifier)(
  ...
  _validateSourceNameExistenceAndCasing(fromDir, sourceName, isLibrary) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        yield (0,
        source_names_1.validateSourceNameExistenceAndCasing)(fromDir, sourceName);
      } catch (error) {
        if (
          errors_1.HardhatError.isHardhatErrorType(
            error,
            errors_list_1.ERRORS.SOURCE_NAMES.FILE_NOT_FOUND
          )
        ) {
          throw new errors_1.HardhatError(
            isLibrary
        ...
        if (
          errors_1.HardhatError.isHardhatErrorType(
            error,
            errors_list_1.ERRORS.SOURCE_NAMES.WRONG_CASING
          )
        ) {
          throw new errors_1.HardhatError(
            errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING,
