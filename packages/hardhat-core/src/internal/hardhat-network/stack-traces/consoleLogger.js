    ...
    return types.map((type, i) => {
      ...
      switch (types[i]) {
        ...
        case logger_1.StringTy:
          const sStart = (0, util_1.bytesToInt)(
            data.slice(position, position + REGISTER_SIZE)
          );
          const sLen = (0, util_1.bytesToInt)(
        ...
        case logger_1.BytesTy:
          const bStart = (0, util_1.bytesToInt)(
            data.slice(position, position + REGISTER_SIZE)
          );
          const bLen = (0, util_1.bytesToInt)(
