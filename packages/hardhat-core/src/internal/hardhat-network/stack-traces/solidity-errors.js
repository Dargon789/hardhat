...
exports.SolidityError =
  exports.encodeSolidityStackTrace =
  exports.wrapWithSolidityErrorsCorrection =
...
function wrapWithSolidityErrorsCorrection(f, stackFramesToRemove) {
  ...
  switch (stackTraceEntry.type) {
    ...
    case solidity_stack_trace_1.StackTraceEntryType
      ...
      return new SolidityCallSite(
        undefined,
        solidity_stack_trace_1.UNRECOGNIZED_CONTRACT_NAME,
        solidity_stack_trace_1.CONSTRUCTOR_FUNCTION_NAME,
        undefined
      );
    case solidity_stack_trace_1.StackTraceEntryType
      .UNRECOGNIZED_CONTRACT_CALLSTACK_ENTRY:
      return new SolidityCallSite(
        (0, util_1.bytesToHex)(stackTraceEntry.address),
        solidity_stack_trace_1.UNRECOGNIZED_CONTRACT_NAME,
        solidity_stack_trace_1.UNKNOWN_FUNCTION_NAME,
        undefined
      );
    case solidity_stack_trace_1.StackTraceEntryType.PRECOMPILE_ERROR:
      return new SolidityCallSite(
        ...
        solidity_stack_trace_1.PRECOMPILE_FUNCTION_NAME,
        undefined
      );
...
function getMessageFromLastStackTraceEntry(stackTraceEntry) {
  switch (stackTraceEntry.type) {
    ...
    case solidity_stack_trace_1.StackTraceEntryType
      ...
      const returnData = new return_data_1.ReturnData(
    ...
    case solidity_stack_trace_1.StackTraceEntryType.PANIC_ERROR:
      const panicMessage = (0, panic_errors_1.panicErrorCodeToMessage)(
        stackTraceEntry.errorCode
      );
