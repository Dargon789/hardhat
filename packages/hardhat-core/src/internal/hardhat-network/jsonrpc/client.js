...
class JsonRpcClient {
  ...
  getDebugTraceTransaction(transactionHash) {
    return __awaiter(this, void 0, void 0, function* () {
      return this._perform(
        "debug_traceTransaction",
        [(0, util_1.bytesToHex)(transactionHash)],
        t.object,
        () => undefined
      );
    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (includeTransactions) {
        return this._perform(
          ...
          [(0, base_types_1.numberToRpcQuantity)(blockNumber), true],
          (0, io_ts_1.nullable)(block_1.rpcBlockWithTransactions),
          (block) => {
            var _a;
            return (_a =
              block === null || block === void 0 ? void 0 : block.number) !==
              null && _a !== void 0
              ? _a
              : undefined;
          }
      ...
      return this._perform(
        "eth_getBlockByNumber",
        [(0, base_types_1.numberToRpcQuantity)(blockNumber), false],
        (0, io_ts_1.nullable)(block_1.rpcBlock),
        (block) => {
          var _a;
          return (_a =
            block === null || block === void 0 ? void 0 : block.number) !==
  ...
  getBlockByHash(blockHash, includeTransactions = false) {
    return __awaiter(this, void 0, void 0, function* () {
      if (includeTransactions) {
        return this._perform(
          "eth_getBlockByHash",
          [(0, util_1.bytesToHex)(blockHash), true],
          (0, io_ts_1.nullable)(block_1.rpcBlockWithTransactions),
          (block) => {
            var _a;
            return (_a =
      ...
      return this._perform(
        "eth_getBlockByHash",
        [(0, util_1.bytesToHex)(blockHash), false],
        (0, io_ts_1.nullable)(block_1.rpcBlock),
        (block) => {
          var _a;
          return (_a =
  ...
  getTransactionByHash(transactionHash) {
    return __awaiter(this, void 0, void 0, function* () {
      return this._perform(
        ...
        [(0, util_1.bytesToHex)(transactionHash)],
        (0, io_ts_1.nullable)(transaction_1.rpcTransaction),
        (tx) => {
          var _a;
          return (_a =
            tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null &&
            _a !== void 0
            ? _a
            : undefined;
        }
  ...
  getTransactionReceipt(transactionHash) {
    return __awaiter(this, void 0, void 0, function* () {
      return this._perform(
        ...
        [(0, util_1.bytesToHex)(transactionHash)],
        (0, io_ts_1.nullable)(receipt_1.rpcTransactionReceipt),
        (tx) => {
          var _a;
          return (_a =
            tx === null || tx === void 0 ? void 0 : tx.blockNumber) !== null &&
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (options.address !== undefined) {
        address = Array.isArray(options.address)
          ? options.address.map((x) => (0, util_1.bytesToHex)(x))
          : (0, util_1.bytesToHex)(options.address);
      }
      let topics;
      if (options.topics !== undefined) {
        topics = options.topics.map((items) =>
          items !== null
            ? items.map((x) => (x !== null ? (0, util_1.bytesToHex)(x) : x))
            : null
        );
      }
      return this._perform(
        ...
        t.array(log_1.rpcLog, "RpcLog Array"),
        () => options.toBlock
      );
    });
  }
  getAccountData(address, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
      const results = yield this._performBatch(
        [
          {
            method: "eth_getCode",
            params: [
  ...
  _perform(method, params, tType, getMaxAffectedBlockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this._forkCachePath !== undefined) {
        const diskCachedResult = yield this._getFromDiskCache(
          this._forkCachePath,
          cacheKey,
          tType
        );
      ...
      const rawResult = yield this._send(method, params);
  ...
  _performBatch(batch, getMaxAffectedBlockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this._forkCachePath !== undefined) {
        const diskCachedResult = yield this._getBatchFromDiskCache(
          this._forkCachePath,
          cacheKey,
          batch.map((b) => b.tType)
        );
      ...
      const rawResults = yield this._sendBatch(batch);
      const decodedResults = rawResults.map((result, i) =>
        (0, decodeJsonRpcResponse_1.decodeJsonRpcResponse)(
          result,
          batch[i].tType
        )
      );
  ...
  _send(method, params, isRetryCall = false) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        return yield this._httpProvider.request({ method, params });
      } catch (err) {
  ...
  _sendBatch(batch, isRetryCall = false) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        return yield this._httpProvider.sendBatch(batch);
      } catch (err) {
        if (this._shouldRetry(isRetryCall, err)) {
  ...
  _getCacheKey(method, params) {
    ...
    const hashed = (0, hash_1.createNonCryptographicHashBasedIdentifier)(
  ...
  _getFromDiskCache(forkCachePath, cacheKey, tType) {
    return __awaiter(this, void 0, void 0, function* () {
      const rawResult = yield this._getRawFromDiskCache(
        forkCachePath,
        cacheKey
      );
  ...
  _getBatchFromDiskCache(forkCachePath, cacheKey, tTypes) {
    return __awaiter(this, void 0, void 0, function* () {
      const rawResults = yield this._getRawFromDiskCache(
        forkCachePath,
        cacheKey
      );
      ...
      return rawResults.map((r, i) =>
        (0, decodeJsonRpcResponse_1.decodeJsonRpcResponse)(r, tTypes[i])
      );
    });
  }
  _getRawFromDiskCache(forkCachePath, cacheKey) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        return yield fs_extra_1.default.readJSON(
  ...
  _storeInDiskCache(forkCachePath, cacheKey, rawResult) {
    return __awaiter(this, void 0, void 0, function* () {
      const requestPath = this._getDiskCachePathForKey(forkCachePath, cacheKey);
      yield fs_extra_1.default.ensureDir(path_1.default.dirname(requestPath));
      yield fs_extra_1.default.writeJSON(requestPath, rawResult, {
        encoding: "utf8",
      });
    });
  }
