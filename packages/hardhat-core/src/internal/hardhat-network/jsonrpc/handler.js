...
class JsonRpcHandler {
  constructor(_provider) {
    ...
    this.handleHttp = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        let jsonHttpRequest;
        try {
          jsonHttpRequest = yield _readJsonHttpRequest(req);
        } catch (error) {
        ...
        const rpcResp = yield this._handleSingleRequest(jsonHttpRequest);
          ...
          __awaiter(this, void 0, void 0, function* () {
            ...
            try {
              ...
              rpcResp = Array.isArray(rpcReq)
                ...
                : yield this._handleSingleWsRequest(rpcReq, subscriptions);
            } catch (error) {
  ...
  _handleSingleRequest(req) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!(0, jsonrpc_1.isValidJsonRequest)(req)) {
        return _handleError(
          new errors_1.InvalidRequestError("Invalid request")
        );
      }
      const rpcReq = req;
      let rpcResp;
      try {
        rpcResp = yield this._handleRequest(rpcReq);
      } catch (error) {
        rpcResp = _handleError(error);
      }
  ...
  _handleSingleWsRequest(rpcReq, subscriptions) {
    return __awaiter(this, void 0, void 0, function* () {
      const rpcResp = yield this._handleSingleRequest(rpcReq);
...
const _readJsonHttpRequest = (req) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let json;
    try {
      const buf = yield (0, raw_body_1.default)(req);
      const text = buf.toString();
      json = JSON.parse(text);
    } catch (error) {
      if (error instanceof Error) {
        throw new errors_1.InvalidJsonInputError(
...
const _handleError = (error) => {
  ...
  if (error.data !== undefined) {
    if (
      ((_a = error.data) === null || _a === void 0 ? void 0 : _a.data) !==
      undefined
    ) {
    ...
    if (
      txHash === undefined &&
      ((_b = error.data) === null || _b === void 0
        ? void 0
        : _b.transactionHash) !== undefined
    ) {
