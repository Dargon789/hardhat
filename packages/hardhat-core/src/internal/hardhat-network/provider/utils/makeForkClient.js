...
exports.getLastSafeBlockNumber =
  exports.makeForkClient =
  exports.makeForkProvider =
    void 0;
...
function makeForkProvider(forkConfig) {
  return __awaiter(this, void 0, void 0, function* () {
    const forkProvider = new http_1.HttpProvider(
      forkConfig.jsonRpcUrl,
      constants_1.HARDHAT_NETWORK_NAME,
      forkConfig.httpHeaders,
      FORK_HTTP_TIMEOUT
    );
    const networkId = yield getNetworkId(forkProvider);
    const actualMaxReorg = (0, reorgs_protection_1.getLargestPossibleReorg)(
      networkId
    );
    const maxReorg =
      actualMaxReorg !== null && actualMaxReorg !== void 0
        ? actualMaxReorg
        : reorgs_protection_1.FALLBACK_MAX_REORG;
    const latestBlockNumber = yield getLatestBlockNumber(forkProvider);
    ...
    if (forkConfig.blockNumber !== undefined) {
      ...
      if (forkConfig.blockNumber > lastSafeBlockNumber) {
        ...
        console.warn(
          picocolors_1.default.yellow(`You are forking from block ${
...
function makeForkClient(forkConfig, forkCachePath) {
  return __awaiter(this, void 0, void 0, function* () {
    const {
      forkProvider,
      networkId,
      ...
      latestBlockNumber,
      maxReorg,
    } = yield makeForkProvider(forkConfig);
    const block = yield getBlockByNumber(forkProvider, forkBlockNumber);
    const forkBlockTimestamp =
      (0, base_types_1.rpcQuantityToNumber)(block.timestamp) * 1000;
    const cacheToDiskEnabled =
      forkConfig.blockNumber !== undefined && forkCachePath !== undefined;
    const forkClient = new client_1.JsonRpcClient(
      forkProvider,
      networkId,
      latestBlockNumber,
      maxReorg,
    ...
    (0,
    errors_1.assertHardhatInvariant)(forkBlockHash !== null, "Forked block should have a hash");
...
function getBlockByNumber(provider, blockNumber) {
  return __awaiter(this, void 0, void 0, function* () {
    const rpcBlockOutput = yield provider.request({
...
function getNetworkId(provider) {
  return __awaiter(this, void 0, void 0, function* () {
    const networkIdString = yield provider.request({
      method: "net_version",
    });
    return parseInt(networkIdString, 10);
  });
}
function getLatestBlockNumber(provider) {
  return __awaiter(this, void 0, void 0, function* () {
    const latestBlockString = yield provider.request({
