...
exports.edrTracingMessageToMinimalMessage =
  exports.edrTracingMessageResultToMinimalEVMResult =
  exports.edrTracingStepToMinimalInterpreterStep =
  exports.edrRpcDebugTraceToHardhat =
  exports.ethereumjsMempoolOrderToEdrMineOrdering =
  exports.ethereumjsIntervalMiningConfigToEdr =
  exports.edrSpecIdToEthereumHardfork =
  exports.ethereumsjsHardforkToEdrSpecId =
    void 0;
...
function ethereumjsMempoolOrderToEdrMineOrdering(mempoolOrder) {
  const { MineOrdering } = (0, napi_rs_1.requireNapiRsModule)(
    "@nomicfoundation/edr"
  );
  switch (mempoolOrder) {
    case "fifo":
...
function edrRpcDebugTraceToHardhat(rpcDebugTrace) {
  ...
  const structLogs = rpcDebugTrace.structLogs.map((log) => {
    ...
    if (log.stack !== undefined) {
      ...
      result.stack =
        (_a = log.stack) === null || _a === void 0
          ? void 0
          : _a.map((item) => item.slice(2));
    }
  ...
  let returnValue =
    (_b =
      (_a = rpcDebugTrace.output) === null || _a === void 0
        ? void 0
        : _a.toString("hex")) !== null && _b !== void 0
      ? _b
      : "";
  if (returnValue === "0x") {
    returnValue = "";
...
function edrTracingMessageResultToMinimalEVMResult(tracingMessageResult) {
  ...
  if (contractAddress !== undefined) {
    minimalEVMResult.execResult.contractAddress = new util_1.Address(
      contractAddress
    );
  }
