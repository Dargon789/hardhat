...
exports.getVarsFilePath =
  exports.writePromptedForHHVSCode =
  exports.hasPromptedForHHVSCode =
  exports.writeTelemetryConsent =
  exports.hasConsentedTelemetry =
  exports.getCompilersDir =
  exports.writeAnalyticsId =
  exports.readSecondLegacyAnalyticsId =
  exports.readFirstLegacyAnalyticsId =
  exports.readAnalyticsId =
  exports.getCacheDir =
    void 0;
...
function generatePaths(packageName = "hardhat") {
  return __awaiter(this, void 0, void 0, function* () {
    const { default: envPaths } = yield Promise.resolve().then(() =>
      __importStar(require("env-paths"))
    );
...
function getDataDir(packageName) {
  return __awaiter(this, void 0, void 0, function* () {
    const { data } = yield generatePaths(packageName);
    yield fs_extra_1.default.ensureDir(data);
    return data;
  });
}
function getCacheDir() {
  return __awaiter(this, void 0, void 0, function* () {
    const { cache } = yield generatePaths();
    yield fs_extra_1.default.ensureDir(cache);
    return cache;
  });
}
exports.getCacheDir = getCacheDir;
function readAnalyticsId() {
  return __awaiter(this, void 0, void 0, function* () {
    const globalDataDir = yield getDataDir();
...
function readFirstLegacyAnalyticsId() {
  const oldIdFile = path_1.default.join(
 ...
 */
function readSecondLegacyAnalyticsId() {
  return __awaiter(this, void 0, void 0, function* () {
    const globalDataDir = yield getDataDir("buidler");
    const idFile = path_1.default.join(globalDataDir, "analytics.json");
    return readId(idFile);
  });
}
exports.readSecondLegacyAnalyticsId = readSecondLegacyAnalyticsId;
function readId(idFile) {
  return __awaiter(this, void 0, void 0, function* () {
    log(`Looking up Client Id at ${idFile}`);
    let clientId;
    try {
      const data = yield fs_extra_1.default.readJSON(idFile, {
        encoding: "utf8",
      });
...
function writeAnalyticsId(clientId) {
  return __awaiter(this, void 0, void 0, function* () {
    const globalDataDir = yield getDataDir();
    const idFile = path_1.default.join(globalDataDir, "analytics.json");
...
function getCompilersDir() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield fs_extra_1.default.ensureDir(compilersCache);
...
function hasConsentedTelemetry() {
  ...
  const telemetryConsentPath = path_1.default.join(
    configDir,
...
function writeTelemetryConsent(consent) {
  ...
  fs_extra_1.default.writeJSONSync(
...
function hasPromptedForHHVSCode() {
  const configDir = getConfigDirSync();
  const extensionPromptedPath = path_1.default.join(
    configDir,
