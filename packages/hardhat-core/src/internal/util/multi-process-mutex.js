...
class MultiProcessMutex {
  constructor(mutexName, maxMutexLifespanInMs) {
    ...
    this._mutexFilePath = node_path_1.default.join(
      node_os_1.default.tmpdir(),
      `${mutexName}.txt`
    );
    this._mutexLifespanInMs =
      maxMutexLifespanInMs !== null && maxMutexLifespanInMs !== void 0
        ? maxMutexLifespanInMs
        : DEFAULT_MAX_MUTEX_LIFESPAN_IN_MS;
  }
  use(f) {
    return __awaiter(this, void 0, void 0, function* () {
      log(`Starting mutex process with mutex file '${this._mutexFilePath}'`);
      while (true) {
        if (yield this._tryToAcquireMutex()) {
  ...
  _executeFunctionAndReleaseMutex(f) {
    return __awaiter(this, void 0, void 0, function* () {
