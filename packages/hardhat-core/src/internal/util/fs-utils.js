...
exports.getFileTrueCaseSync =
  exports.getFileTrueCase =
  exports.getAllFilesMatchingSync =
  exports.getAllFilesMatching =
  exports.getRealPathSync =
  exports.getRealPath =
  exports.InvalidDirectoryError =
  exports.FileNotFoundError =
  exports.FileSystemAccessError =
    void 0;
 ...
 */
function getRealPath(absolutePath) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      // This method returns the actual casing.
      // Please read Node.js' docs to learn more.
      return yield promises_1.default.realpath(
        path_1.default.normalize(absolutePath)
      );
    } catch (e) {
      if (e.code === "ENOENT") {
...
function getRealPathSync(absolutePath) {
  try {
    // This method returns the actual casing.
    // Please read Node.js' docs to learn more.
    return fs_1.default.realpathSync.native(
      path_1.default.normalize(absolutePath)
    );
  } catch (e) {
    if (e.code === "ENOENT") {
 ...
 */
function getAllFilesMatching(absolutePathToDir, matches) {
  return __awaiter(this, void 0, void 0, function* () {
    const dir = yield readdir(absolutePathToDir);
    const results = yield Promise.all(
      dir.map((file) =>
        __awaiter(this, void 0, void 0, function* () {
          const absolutePathToFile = path_1.default.join(
            absolutePathToDir,
            file
          );
          const stats = yield promises_1.default.stat(absolutePathToFile);
          if (stats.isDirectory()) {
            const files = yield getAllFilesMatching(
              absolutePathToFile,
              matches
            );
            return files.flat();
 ...
 * resolving symlinks.
 */
function getFileTrueCase(from, relativePath) {
  return __awaiter(this, void 0, void 0, function* () {
    const dirEntries = yield readdir(from);
    ...
    for (const dirEntry of dirEntries) {
      if (dirEntry.toLowerCase() === nextDirLowerCase) {
        ...
        return path_1.default.join(
          dirEntry,
          yield getFileTrueCase(
            path_1.default.join(from, dirEntry),
            path_1.default.relative(parts[0], relativePath)
          )
        );
      }
    }
...
function readdir(absolutePathToDir) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      return yield promises_1.default.readdir(absolutePathToDir);
    } catch (e) {
      if (e.code === "ENOENT") {
        return [];
      }
