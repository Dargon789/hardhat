...
exports.includesOwnPackageName =
  exports.replaceBackslashes =
  exports.isAbsolutePathSourceName =
  exports.normalizeSourceName =
  exports.localSourceNameToPath =
  exports.localPathToSourceName =
  exports.validateSourceNameExistenceAndCasing =
  exports.isLocalSourceName =
  exports.validateSourceNameFormat =
    void 0;
...
function validateSourceNameFormat(sourceName) {
  if (isAbsolutePathSourceName(sourceName)) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NAME_ABSOLUTE_PATH,
      {
        name: sourceName,
      }
    );
  ...
  if (isExplicitRelativePath(sourceName)) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NAME_RELATIVE_PATH,
      {
        name: sourceName,
      }
    );
  ...
  if (replaceBackslashes(sourceName) !== sourceName) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NAME_BACKSLASHES,
      {
        name: sourceName,
      }
    );
  ...
  if (normalizeSourceName(sourceName) !== sourceName) {
    throw new errors_1.HardhatError(
      errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NOT_NORMALIZED,
      {
        name: sourceName,
      }
    );
 ...
 */
function isLocalSourceName(projectRoot, sourceName) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      yield (0, fs_utils_1.getFileTrueCase)(projectRoot, firstDirOrFileName);
    } catch (error) {
 ...
 * The source name must be in a valid format.
 */
function validateSourceNameExistenceAndCasing(fromDir, sourceName) {
  return __awaiter(this, void 0, void 0, function* () {
    const trueCaseSourceName = yield getSourceNameTrueCase(fromDir, sourceName);
 ...
 * to a library.
 */
function localPathToSourceName(projectRoot, localFileAbsolutePath) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (normalized.startsWith("..")) {
      throw new errors_1.HardhatError(
        errors_list_1.ERRORS.SOURCE_NAMES.EXTERNAL_AS_LOCAL,
        {
    ...
    if (normalized.includes(NODE_MODULES)) {
      throw new errors_1.HardhatError(
        errors_list_1.ERRORS.SOURCE_NAMES.NODE_MODULES_AS_LOCAL,
        {
          path: localFileAbsolutePath,
        }
      );
 ...
 */
function getSourceNameTrueCase(fromDir, p) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      const realCase = yield (0, fs_utils_1.getFileTrueCase)(
        fromDir,
        slashesToPathSeparator(p)
      );
 ...
 * as a substring
 */
function includesOwnPackageName(sourceName) {
  return __awaiter(this, void 0, void 0, function* () {
    const packageName = yield (0, packageInfo_1.getPackageName)(sourceName);
    if (packageName !== "") {
