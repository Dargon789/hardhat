...
(0, config_1.extendEnvironment)((hre) => {
    if (hre.ignition !== undefined &&
        ...
        throw new plugins_1.HardhatPluginError("hardhat-ignition-viem", `Found ${hre.ignition.type} and viem, but only one Hardhat Ignition extension plugin can be used at a time.`);
    }
