...
class ViemIgnitionHelper {
    ...
    static _toViemContracts(hre, ignitionModule, result) {
        return __awaiter(this, void 0, void 0, function* () {
            return Object.fromEntries(yield Promise.all(Object.entries(ignitionModule.results).map(([name, contractFuture]) => __awaiter(this, void 0, void 0, function* () {
                return [
                    name,
                    yield ViemIgnitionHelper._getContract(hre, contractFuture, result.contracts[contractFuture.id]),
                ];
            }))));
        });
    }
    static _getContract(hre, future, deployedContract) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return ViemIgnitionHelper._convertContractFutureToViemContract(hre, future, deployedContract);
        });
    }
    static _convertContractFutureToViemContract(hre, future, deployedContract) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (future.type) {
                ...
                case ignition_core_1.FutureType.NAMED_ARTIFACT_CONTRACT_AT:
                    return ViemIgnitionHelper._convertHardhatContractToViemContract(hre, future, deployedContract);
                ...
                case ignition_core_1.FutureType.CONTRACT_AT:
                    return ViemIgnitionHelper._convertArtifactToViemContract(hre, future, deployedContract);
            }
        });
    }
    static _convertHardhatContractToViemContract(hre, future, deployedContract) {
        return hre.viem.getContractAt(future.contractName, ViemIgnitionHelper._ensureAddressFormat(deployedContract.address));
    }
    static _convertArtifactToViemContract(hre, future, deployedContract) {
        return __awaiter(this, void 0, void 0, function* () {
            const publicClient = yield hre.viem.getPublicClient();
            const [walletClient] = yield hre.viem.getWalletClients();
            ...
            const contract = viem.getContract({
                address: ViemIgnitionHelper._ensureAddressFormat(deployedContract.address),
