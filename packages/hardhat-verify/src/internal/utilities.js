 ...
 */
function printSupportedNetworks(customChains) {
    return __awaiter(this, void 0, void 0, function* () {
        const { table } = yield Promise.resolve().then(() => __importStar(require("table")));
        // supported networks
        ...
        const supportedNetworksTable = table([
            [picocolors_1.default.bold("network"), picocolors_1.default.bold("chain id")],
            ...supportedNetworks,
        ]);
        // custom networks
...
function printVerificationErrors(errors) {
    ...
    console.error(picocolors_1.default.red(errorMessage));
}
 ...
 */
function resolveConstructorArguments(constructorArgsParams, constructorArgsModule) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        ...
        try {
            const constructorArguments = (yield (_a = constructorArgsModulePath, Promise.resolve().then(() => __importStar(require(_a)))))
                .default;
 ...
 */
function resolveLibraries(librariesModule) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        ...
        try {
            const libraries = (yield (_a = librariesModulePath, Promise.resolve().then(() => __importStar(require(_a))))).default;
 ...
 */
function getCompilerVersions({ compilers, overrides, }) {
    return __awaiter(this, void 0, void 0, function* () {
        {
            ...
            const semver = yield Promise.resolve().then(() => __importStar(require("semver")));
 ...
 */
function encodeArguments(abi, sourceName, contractName, constructorArguments) {
    return __awaiter(this, void 0, void 0, function* () {
        const { Interface } = yield Promise.resolve().then(() => __importStar(require("@ethersproject/abi")));
        ...
        try {
            ...
            constructorArguments.forEach((arg, i) => {
                var _a;
                if (((_a = expectedConstructorArgs[i]) === null || _a === void 0 ? void 0 : _a.type) === "string" &&
                    typeof arg !== "string") {
