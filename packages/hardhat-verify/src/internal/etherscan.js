...
class Etherscan {
    ...
    static getCurrentChainConfig(networkName, ethereumProvider, customChains) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentChainId = parseInt(yield ethereumProvider.send("eth_chainId"), 16);
    ...
    isVerified(address) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sourceCode = (_a = json.result[0]) === null || _a === void 0 ? void 0 : _a.SourceCode;
     ...
     */
    verify(contractAddress, sourceCode, contractName, compilerVersion, constructorArguments) {
        return __awaiter(this, void 0, void 0, function* () {
            const parameters = new URLSearchParams({
                apikey: this.apiKey,
                module: "contract",
            ...
            let json;
            try {
                response = yield (0, undici_1.sendPostRequest)(url, parameters.toString(), {
    ...
    getVerificationStatus(guid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (etherscanResponse.isPending()) {
                yield (0, utilities_1.sleep)(VERIFICATION_STATUS_POLLING_TIME);
