...
class Blockscout {
     ...
     */
    verify(contractAddress, sourceCode, contractName, compilerVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            const etherscanResponse = yield this._etherscan.verify(contractAddress, sourceCode, contractName, compilerVersion, "");
    ...
    getVerificationStatus(guid) {
        return __awaiter(this, void 0, void 0, function* () {
            const etherscanResponse = yield this._etherscan.getVerificationStatus(guid);
            return new BlockscoutResponse(etherscanResponse.status, etherscanResponse.message);
        });
    }
    /**
