 ...
 * information.
 */
function extractInferredContractInformation(artifacts, network, matchingCompilerVersions, bytecode) {
    return __awaiter(this, void 0, void 0, function* () {
        const contractMatches = yield lookupMatchingBytecode(artifacts, matchingCompilerVersions, bytecode);
 ...
 */
function getLibraryInformation(contractInformation, userLibraries) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const normalizedLibraries = yield normalizeLibraries(allLibraries, detectableLibraries, undetectableLibraries, userLibraries, contractInformation.contractName);
...
function lookupMatchingBytecode(artifacts, matchingCompilerVersions, bytecode) {
    return __awaiter(this, void 0, void 0, function* () {
        const contractMatches = [];
        const fqNames = yield artifacts.getAllFullyQualifiedNames();
        for (const fqName of fqNames) {
            const buildInfo = yield artifacts.getBuildInfo(fqName);
...
function normalizeLibraries(allLibraries, detectableLibraries, undetectableLibraries, userLibraries, contractName) {
    return __awaiter(this, void 0, void 0, function* () {
