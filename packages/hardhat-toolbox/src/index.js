...
(0, config_1.extendConfig)((config, userConfig) => {
    ...
    if ((gasReporterConfig === null || gasReporterConfig === void 0 ? void 0 : gasReporterConfig.enabled) === undefined) {
        // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
        configAsAny.gasReporter.enabled = process.env.REPORT_GAS ? true : false;
    }
    if ((gasReporterConfig === null || gasReporterConfig === void 0 ? void 0 : gasReporterConfig.currency) === undefined) {
        configAsAny.gasReporter.currency = "USD";
    }
    // We don't generate types for js projects
    if (((_a = userConfig === null || userConfig === void 0 ? void 0 : userConfig.typechain) === null || _a === void 0 ? void 0 : _a.dontOverrideCompile) === undefined) {
