 ...
 * @beta
 */
function trackTransaction(deploymentDir, txHash, provider, requiredConfirmations = defaultConfig_1.defaultConfig.requiredConfirmations, applyNewMessageFn = deployment_state_helpers_1.applyNewMessage) {
    var _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transaction = yield jsonRpcClient.getFullTransaction(txHash);
            ...
            for (const networkInteraction of exState.networkInteractions) {
                if (networkInteraction.type ===
                    ...
                    if (networkInteraction.transactions.length === 0) {
                        ...
                        if (((_c = networkInteraction.to) === null || _c === void 0 ? void 0 : _c.toLowerCase()) ===
                            ((_d = transaction.to) === null || _d === void 0 ? void 0 : _d.toLowerCase()) &&
                            ...
                            yield applyNewMessageFn(transactionSendMessage, deploymentState, deploymentLoader);
                            return;
                        }
...
function checkConfirmations(exState, networkInteraction, transaction, requiredConfirmations, jsonRpcClient, deploymentState, deploymentLoader, applyNewMessageFn) {
    return __awaiter(this, void 0, void 0, function* () {
        const [block, receipt] = yield Promise.all([
        ...
        if (confirmations >= requiredConfirmations) {
            ...
            yield applyNewMessageFn(transactionReplacedMessage, deploymentState, deploymentLoader);
            /**
