...
function reconcileArtifacts(future, exState, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const moduleArtifact = "artifact" in future
            ? future.artifact
            : yield context.artifactResolver.loadArtifact(future.contractName);
        const storedArtifact = yield context.deploymentLoader.loadArtifact(exState.artifactId);
