...
function validateNamedEncodeFunctionCall(future, artifactLoader, deploymentParameters, accounts) {
    return __awaiter(this, void 0, void 0, function* () {
        const errors = [];
        /* stage one */
        const artifact = "artifact" in future.contract
            ? future.contract.artifact
            : yield artifactLoader.loadArtifact(future.contract.contractName);
