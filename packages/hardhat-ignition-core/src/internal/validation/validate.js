...
function validate(module, artifactLoader, deploymentParameters, accounts) {
    return __awaiter(this, void 0, void 0, function* () {
        const futures = (0, get_futures_from_module_1.getFuturesFromModule)(module);
        const errors = {};
        for (const future of futures) {
            const validationErrors = yield _validateFuture(future, artifactLoader, deploymentParameters, accounts);
...
function _validateFuture(future, artifactLoader, deploymentParameters, accounts) {
    return __awaiter(this, void 0, void 0, function* () {
        switch (future.type) {
