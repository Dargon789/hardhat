...
class IgnitionModuleBuilderImplementation {
    ...
    _namedArtifactContract(contractName, args = [], options = {}) {
        ...
        (_a = options.libraries) !== null && _a !== void 0 ? _a : (options.libraries = {});
        (_b = options.value) !== null && _b !== void 0 ? _b : (options.value = BigInt(0));
        /* validation start */
        ...
        for (const afterFuture of (_c = options.after) !== null && _c !== void 0 ? _c : []) {
            future.dependencies.add(afterFuture);
            if (!(0, type_guards_1.isFuture)(afterFuture)) {
    ...
    _namedArtifactLibrary(libraryName, options = {}) {
        ...
        for (const afterFuture of (_b = options.after) !== null && _b !== void 0 ? _b : []) {
            future.dependencies.add(afterFuture);
            if (!(0, type_guards_1.isFuture)(afterFuture)) {
                this._module.submodules.add(afterFuture);
            }
    ...
    call(contractFuture, functionName, args = [], options = {}) {
        ...
        (_a = options.value) !== null && _a !== void 0 ? _a : (options.value = BigInt(0));
        /* validation start */
    ...
    staticCall(contractFuture, functionName, args = [], nameOrIndex = 0, options = {}) {
        ...
        for (const afterFuture of (_a = options.after) !== null && _a !== void 0 ? _a : []) {
            future.dependencies.add(afterFuture);
            if (!(0, type_guards_1.isFuture)(afterFuture)) {
                this._module.submodules.add(afterFuture);
            }
    ...
    readEventArgument(futureToReadFrom, eventName, nameOrIndex, options = {}) {
        ...
        const eventIndex = (_a = options.eventIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        const contractToReadFrom = "contract" in futureToReadFrom
            ...
            : futureToReadFrom;
        const emitter = (_b = options.emitter) !== null && _b !== void 0 ? _b : contractToReadFrom;
    ...
    send(id, to, value, data, options = {}) {
        ...
        const val = value !== null && value !== void 0 ? value : BigInt(0);
        /* validation start */
