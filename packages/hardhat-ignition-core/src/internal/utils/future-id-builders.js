...
function toReadEventArgumentFutureId(moduleId, userProvidedId, contractName, eventName, nameOrIndex, eventIndex) {
    const futureKey = userProvidedId !== null && userProvidedId !== void 0 ? userProvidedId : `${contractName}${SUBKEY_SEPERATOR}${eventName}${SUBKEY_SEPERATOR}${nameOrIndex}${SUBKEY_SEPERATOR}${eventIndex}`;
