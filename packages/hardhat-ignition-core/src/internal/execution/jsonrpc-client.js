...
class EIP1193JsonRpcClient {
    ...
    getChainId() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._provider.request({
                method: "eth_chainId",
                params: [],
            });
    ...
    getNetworkFees() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const fees = yield this._getNetworkFees();
            const maxFees = "gasPrice" in fees ? fees.gasPrice : fees.maxFeePerGas;
            if (((_a = this._config) === null || _a === void 0 ? void 0 : _a.maxFeePerGasLimit) !== undefined &&
    ...
    getBalance(address, blockTag) {
        return __awaiter(this, void 0, void 0, function* () {
            const balance = yield this._provider.request({
    ...
    setBalance(address, balance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const returnedBalance = yield this._provider.request({
    ...
    call(callParams, blockTag) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jsonRpcEncodedParams = Object.assign({ to: callParams.to, value: bigIntToJsonRpcQuantity(callParams.value), data: callParams.data, from: callParams.from, nonce: callParams.nonce !== undefined
                        ? numberToJsonRpcQuantity(callParams.nonce)
                        : undefined, gas: callParams.gasLimit !== undefined
                        ? bigIntToJsonRpcQuantity(callParams.gasLimit)
                        : undefined }, jsonRpcEncodeNetworkFees(callParams.fees));
                const response = yield this._provider.request({
                    method: "eth_call",
                ...
                if (error instanceof Error) {
                    ...
                    const data = typeof errorWithData.data === "string"
                        ? errorWithData.data
                        : (_a = errorWithData.data) === null || _a === void 0 ? void 0 : _a.data;
                    if (data !== undefined) {
                        return {
                            success: false,
                            returnData: data,
    ...
    estimateGas(estimateGasParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const jsonRpcEncodedParams = Object.assign({ to: estimateGasParams.to, value: bigIntToJsonRpcQuantity(estimateGasParams.value), data: estimateGasParams.data, from: estimateGasParams.from, nonce: numberToJsonRpcQuantity(estimateGasParams.nonce) }, jsonRpcEncodeNetworkFees(estimateGasParams.fees));
            const response = yield this._provider.request({
    ...
    sendTransaction(transactionParams) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jsonRpcEncodedParams = Object.assign({ to: transactionParams.to, value: bigIntToJsonRpcQuantity(transactionParams.value), data: transactionParams.data, from: transactionParams.from, nonce: numberToJsonRpcQuantity(transactionParams.nonce), gas: bigIntToJsonRpcQuantity(transactionParams.gasLimit) }, jsonRpcEncodeNetworkFees(transactionParams.fees));
                const response = yield this._provider.request({
    ...
    sendRawTransaction(presignedTx) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._provider.request({
    ...
    getFullTransaction(txHash) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                data: response.input,
                from: response.from,
                to: (_a = response.to) !== null && _a !== void 0 ? _a : undefined,
    ...
    getTransactionReceipt(txHash) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractAddress = status === jsonrpc_1.TransactionReceiptStatus.SUCCESS
                ? (_a = response.contractAddress) !== null && _a !== void 0 ? _a : undefined
                : undefined;
            return {
                blockHash: response.blockHash,
    ...
    getCode(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this._provider.request({
                method: "eth_getCode",
    ...
    _getNetworkFees() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const [latestBlock, chainId] = yield Promise.all([
                this.getLatestBlock(),
                this.getChainId(),
            ]);
            ...
            if (latestBlock.baseFeePerGas !== undefined &&
                ...
                const maxPriorityFeePerGas = yield this._resolveMaxPriorityFeePerGas();
            ...
            if (((_a = this._config) === null || _a === void 0 ? void 0 : _a.gasPrice) !== undefined) {
     ...
     */
    _resolveMaxPriorityFeePerGas() {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            if (((_a = this._config) === null || _a === void 0 ? void 0 : _a.maxPriorityFeePerGas) !== undefined) {
                return (_b = this._config) === null || _b === void 0 ? void 0 : _b.maxPriorityFeePerGas;
            }
            try {
                return yield this._getMaxPriorityFeePerGas();
            }
            catch (_c) {
    ...
    _getMaxPriorityFeePerGas() {
        return __awaiter(this, void 0, void 0, function* () {
            const fee = yield this._provider.request({
