 ...
 */
function sendTransaction(exState, executionStrategy, jsonRpcClient, nonceManager, transactionTrackingTimer, deploymentLoader) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const generator = yield (0, replay_strategy_1.replayStrategy)(exState, executionStrategy);
        // This cast is safe because the execution state is of static call type.
        const strategyGenerator = generator;
        const result = yield (0, network_interaction_execution_1.sendTransactionForOnchainInteraction)(jsonRpcClient, exState.from, lastNetworkInteraction, nonceManager, (0, decode_simulation_result_1.decodeSimulationResult)(strategyGenerator, exState), deploymentLoader, exState.id);
