 ...
 */
function resolveReadEventArgumentResult(future, emitter, eventName, eventIndex, nameOrIndex, deploymentState, deploymentLoader) {
    return __awaiter(this, void 0, void 0, function* () {
        const emitterAddress = resolveAddressForContractFuture(emitter, deploymentState);
        const emitterArtifact = yield deploymentLoader.loadArtifact(emitter.id);
...
function resolveEncodeFunctionCallResult(artifactId, functionName, args, deploymentLoader) {
    return __awaiter(this, void 0, void 0, function* () {
        const artifact = yield deploymentLoader.loadArtifact(artifactId);
