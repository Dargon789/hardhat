...
function buildInitializeMessageFor(future, deploymentState, strategy, deploymentParameters, deploymentLoader, accounts, defaultSender) {
    return __awaiter(this, void 0, void 0, function* () {
        switch (future.type) {
            ...
            case module_1.FutureType.ENCODE_FUNCTION_CALL: {
                ...
                const result = yield (0, future_resolvers_1.resolveEncodeFunctionCallResult)(future.contract.id, future.functionName, args, deploymentLoader);
            ...
            case module_1.FutureType.READ_EVENT_ARGUMENT: {
                const { txToReadFrom, emitterAddress, result } = yield (0, future_resolvers_1.resolveReadEventArgumentResult)(future.futureToReadFrom, future.emitter, future.eventName, future.eventIndex, future.nameOrIndex, deploymentState, deploymentLoader);
...
function _extendBaseInitWith(messageType, future, strategy, strategyConfig, extension) {
    return Object.assign({ type: messageType, futureId: future.id, strategy,
        strategyConfig, dependencies: [...future.dependencies].map((f) => f.id) }, extension);
}
