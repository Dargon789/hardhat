...
function deploymentStateReducer(state, action) {
    ...
    return Object.assign(Object.assign({}, state), { executionStates: Object.assign(Object.assign({}, state.executionStates), { [action.futureId]: (0, execution_state_reducer_1.executionStateReducer)(previousExState, action) }) });
}
