...
class Deployer {
    ...
    deploy(ignitionModule, deploymentParameters, accounts, defaultSender) {
        return __awaiter(this, void 0, void 0, function* () {
            const deployment = yield this._getOrInitializeDeploymentState();
            ...
            const contractStates = contracts
                .map((contract) => deploymentState === null || deploymentState === void 0 ? void 0 : deploymentState.executionStates[contract.id])
            ...
            const reconciliationResult = yield reconciler_1.Reconciler.reconcile(ignitionModule, deploymentState, deploymentParameters, accounts, this._deploymentLoader, this._artifactResolver, defaultSender, this._executionStrategy.name, this._executionStrategy.config);
            ...
            if (this._hasBatchesToExecute(batches)) {
                ...
                deploymentState = yield executionEngine.executeModule(deploymentState, ignitionModule, batches, accounts, deploymentParameters, defaultSender);
            }
            const result = yield this._getDeploymentResult(deploymentState, ignitionModule);
            this._emitDeploymentCompleteEvent(result);
            return result;
        });
    }
    _getDeploymentResult(deploymentState, _module) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * new).
     */
    _getOrInitializeDeploymentState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deploymentState === undefined) {
                const newState = yield (0, deployment_state_helpers_1.initializeDeploymentState)(chainId, this._deploymentLoader);
    ...
    _emitDeploymentStartEvent(moduleId, deploymentDir, isResumed, maxFeeBumps, disableFeeBumping) {
        ...
        this._executionEventListener.deploymentStart({
            ...
            moduleName: moduleId,
            deploymentDir: deploymentDir !== null && deploymentDir !== void 0 ? deploymentDir : undefined,
            isResumed,
            maxFeeBumps,
            disableFeeBumping,
        });
    ...
    _getExecutionErrorResult(deploymentState) {
        ...
        return Object.assign({ type: deploy_1.DeploymentResultType.EXECUTION_ERROR }, status);
    }
    /**
