 ...
 * @beta
 */
function status(deploymentDir, _artifactResolver) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const [futureId, deployedContract] of Object.entries(deployedContracts)) {
            const artifact = yield deploymentLoader.loadArtifact(deployedContract.id);
            contracts[futureId] = Object.assign(Object.assign({}, deployedContract), { contractName: artifact.contractName, sourceName: artifact.sourceName, abi: artifact.abi });
        }
        const statusResult = Object.assign(Object.assign({}, futureStatuses), { chainId: deploymentState.chainId, contracts });
        return statusResult;
    });
}
