...
const validateNamedContractCall_1 = require("../src/internal/validation/futures/validateNamedContractCall");
...
describe("call", () => {
    it("should be able to setup a contract call", () => {
        ...
        chai_1.assert.equal([...moduleWithASingleContract.futures][1].type, module_2.FutureType.CONTRACT_CALL);
        // No submodules
    ...
    it("should be able to pass value as an option", () => {
        ...
        chai_1.assert.equal(callFuture.value, BigInt(42));
    });
    it("Should be able to pass an ModuleParameterRuntimeValue as a value option", () => {
        ...
        (0, helpers_1.assertInstanceOf)(callFuture.value, module_1.ModuleParameterRuntimeValueImplementation);
    });
    ...
    describe("Arguments", () => {
        it("Should support base values as arguments", () => {
            ...
            const future = [...module.futures].find(({ type }) => type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertInstanceOf)(future, module_1.NamedContractCallFutureImplementation);
...
m.call(..., { id: "MyUniqueId"})`);
    ...
    describe("validation", () => {
        ...
        it("should not validate a non-existant hardhat contract", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Another: {} }), {}, []), "Artifact for contract 'Another' is invalid");
        }));
        it("should not validate a non-existant function", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)(), {}, []), "Function 'test' not found in contract Another");
        }));
        it("should not validate a call with wrong number of arguments", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)(), {}, []), "Function inc in contract Another expects 1 arguments but 2 were given");
        }));
        it("should not validate an overloaded call with wrong number of arguments", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)(), {}, []), "Function inc(bool,uint256) in contract Another expects 2 arguments but 3 were given");
        }));
        it("should not validate a missing module parameter", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Another: helpers_1.fakeArtifact }), {}, []), "Module parameter 'p' requires a value but was given none");
        }));
        it("should not validate a module parameter of the wrong type for value", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Another: helpers_1.fakeArtifact }), {}, []), "Module parameter 'p' must be of type 'bigint' but is 'boolean'");
        }));
        it("should validate a module parameter of the correct type for value", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            yield chai_1.assert.isFulfilled((0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Another: helpers_1.fakeArtifact }), {}, []));
        }));
        it("should validate a missing module parameter if a default parameter is present", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            const result = yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Another: helpers_1.fakeArtifact }), {}, []);
        ...
        it("should not validate a module parameter with a default value that is an AccountRuntimeValue for a negative index", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)({ Test: fakerArtifact }), {}, []), "Account index cannot be a negative number");
        }));
        it("should not validate a negative account index", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)(), {}, []), "Account index cannot be a negative number");
        }));
        it("should not validate an account index greater than the number of available accounts", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === module_2.FutureType.CONTRACT_CALL);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractCall_1.validateNamedContractCall)(future, (0, helpers_1.setupMockArtifactResolver)(), {}, []), "Requested account index '1' is greater than the total number of available accounts '0'");
        }));
    });
});
