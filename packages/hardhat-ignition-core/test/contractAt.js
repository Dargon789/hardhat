...
const validateNamedContractAt_1 = require("../src/internal/validation/futures/validateNamedContractAt");
    ...
    describe("validation", () => {
        describe("module stage", () => {
            it("should not validate an invalid address", () => {
                chai_1.assert.throws(() => (0, build_module_1.buildModule)("Module1", (m) => {
                    const another = m.contractAt("Another", 42);
                    return { another };
        ...
        it("should not validate an invalid artifact", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractAt_1.validateNamedContractAt)(future, (0, helpers_1.setupMockArtifactResolver)({
                Another: { _kind: "invalid artifact" },
        ...
        it("should not validate a missing module parameter", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === src_1.FutureType.NAMED_ARTIFACT_CONTRACT_AT);
            (0, helpers_1.assertValidationError)(yield (0, validateNamedContractAt_1.validateNamedContractAt)(future, (0, helpers_1.setupMockArtifactResolver)({
        ...
        it("should validate a missing module parameter if a default parameter is present", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const future = (0, get_futures_from_module_1.getFuturesFromModule)(module).find((v) => v.type === src_1.FutureType.NAMED_ARTIFACT_CONTRACT_AT);
            const result = yield (0, validateNamedContractAt_1.validateNamedContractAt)(future, (0, helpers_1.setupMockArtifactResolver)({
                Another: helpers_1.fakeArtifact,
            }), {}, []);
