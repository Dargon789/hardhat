...
describe("Reconciliation - named contract call", () => {
    ...
    const exampleContractCallState = {
        id: "Example",
    ...
    it("should reconcile unchanged", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, helpers_2.assertSuccessReconciliation)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Submodule#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
            ...
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Submodule#Contract1.function1", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.SUCCESS, functionName: "function1", args: [1, "a", differentAddress] })));
    }));
    it("should reconcile when the from is undefined but the exState's from is in the accounts list", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, helpers_2.assertSuccessReconciliation)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#Contract1.function1", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.SUCCESS, functionName: "function1", args: [1, "a", differentAddress], from: helpers_1.exampleAccounts[2] })));
    }));
    it("should find changes to contract unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", contractAddress: exampleAddress })));
    ...
    it("should find changes to function name unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "functionUnchanged" })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#config",
    ...
    it("should find changes to function args unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#Contract1.function1", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", args: [["UNCHANGED"]] })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
    ...
    it("should reconcile an address arg with entirely different casing", () => __awaiter(void 0, void 0, void 0, function* () {
        const moduleDefinition = (0, build_module_1.buildModule)("Module", (m) => {
            const contract1 = m.contract("Contract1");
            m.call(contract1, "function1", ["0x15d34aaf54267db7d7c367839aaf71a00a2c6a65"], {});
            return { contract1 };
        });
        yield (0, helpers_2.assertSuccessReconciliation)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#Contract1.function1", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", args: ["0x15D34AAF54267DB7D7C367839AAF71A00A2C6A65"] })));
    }));
    ...
    it("should find changes to value unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", value: BigInt(2) })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#config",
    ...
    it("should find changes to from unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        const moduleDefinition = (0, build_module_1.buildModule)("Module", (m) => {
            const contract1 = m.contract("Contract1");
            m.call(contract1, "function1", [], { id: "config", from: helpers_2.twoAddress });
            return { contract1 };
        });
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", from: helpers_2.oneAddress })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#config",
    ...
    it("should find changes to strategy name unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", strategy: "create2" })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#config",
    ...
    it("should find changes to strategy config unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", status: execution_state_1.ExecutionStatus.SUCCESS, result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: differentAddress,
            } }), Object.assign(Object.assign({}, exampleContractCallState), { id: "Module#config", futureType: module_1.FutureType.CONTRACT_CALL, status: execution_state_1.ExecutionStatus.STARTED, functionName: "function1", strategyConfig: { salt: "value" } })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#config",
