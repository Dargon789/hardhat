...
describe("Reconciliation - artifact contract", () => {
    ...
    it("should reconcile unchanged", () => __awaiter(void 0, void 0, void 0, function* () {
        const submoduleDefinition = (0, build_module_1.buildModule)("Submodule", (m) => {
            ...
            const contract1 = m.contract("Contract1", helpers_2.mockArtifact, [{ supply }], {
                libraries: {
                    SafeMath: safeMath,
                },
            });
        ...
        yield (0, helpers_2.assertSuccessReconciliation)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Submodule#SafeMath", futureType: module_1.FutureType.NAMED_ARTIFACT_LIBRARY_DEPLOYMENT, status: execution_state_1.ExecutionStatus.SUCCESS, contractName: "SafeMath", result: {
            ...
            } }), Object.assign(Object.assign({}, exampleDeploymentState), { id: "Submodule#Contract1", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, constructorArgs: [{ supply: BigInt(1000) }], libraries: {
                SafeMath: exampleAddress,
            } })));
    }));
    it("should find changes to contract name unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        const moduleDefinition = (0, build_module_1.buildModule)("Module", (m) => {
            const contract1 = m.contract("ContractChanged", helpers_2.mockArtifact, [], {
                id: "Example",
            });
            return { contract1 };
        });
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Example", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, contractName: "ContractUnchanged" })));
    ...
    it("should find changes to constructors unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        const moduleDefinition = (0, build_module_1.buildModule)("Module", (m) => {
            const owner = m.getAccount(3);
            const supply = m.getParameter("supply", BigInt(500));
            const ticker = m.getParameter("ticker", "CodeCoin");
            const contract1 = m.contract("Contract1", helpers_2.mockArtifact, [
                owner,
                { nested: { supply } },
                [1, ticker, 3],
            ]);
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, constructorArgs: [
    ...
    it("should reconcile an address arg with entirely different casing", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, helpers_2.assertSuccessReconciliation)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, constructorArgs: ["0x15D34AAF54267DB7D7C367839AAF71A00A2C6A65"] })));
    }));
    ...
    it("should find changes to libraries unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#SafeMath", futureType: module_1.FutureType.NAMED_ARTIFACT_LIBRARY_DEPLOYMENT, status: execution_state_1.ExecutionStatus.SUCCESS, contractName: "SafeMath", result: {
                type: execution_result_1.ExecutionResultType.SUCCESS,
                address: exampleAddress,
            } }), Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Contract1", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, libraries: {} })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#Contract1",
    ...
    it("should find changes to value unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Example", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, value: BigInt(3) })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#Example",
    ...
    it("should find changes to from unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Example", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, from: helpers_2.oneAddress })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#Example",
    ...
    it("should find changes to strategy name unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Example", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, strategy: "create2" })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#Example",
    ...
    it("should find changes to strategy config unreconciliable", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const reconiliationResult = yield (0, helpers_2.reconcile)(moduleDefinition, (0, helpers_2.createDeploymentState)(Object.assign(Object.assign({}, exampleDeploymentState), { id: "Module#Example", futureType: module_1.FutureType.CONTRACT_DEPLOYMENT, status: execution_state_1.ExecutionStatus.STARTED, strategyConfig: { salt: "value" } })));
        chai_1.assert.deepStrictEqual(reconiliationResult.reconciliationFailures, [
            {
                futureId: "Module#Example",
