...
(0, config_1.extendEnvironment)((env) => {
    env.artifacts.require = (0, plugins_1.lazyFunction)(() => {
        ...
        function addFromIfNeededAndAvailable(params) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (params.from === undefined) {
                    if (defaultAccount === undefined) {
                        accounts = yield env.web3.eth.getAccounts();
        ...
        monkeyPatchMethod(execute, "getGasEstimate", (og) => function (params, ...others) {
            return __awaiter(this, void 0, void 0, function* () {
                yield addFromIfNeededAndAvailable(params);
                return og.call(execute, params, ...others);
            });
        });
        monkeyPatchMethod(execute, "prepareCall", (og) => function (...args) {
            return __awaiter(this, void 0, void 0, function* () {
                const ret = yield og.apply(execute, args);
                yield addFromIfNeededAndAvailable(ret.params);
                return ret;
            });
        });
...
(0, config_1.subtask)(task_names_1.TASK_TEST_SETUP_TEST_ENVIRONMENT, (_, { web3, network }) => __awaiter(void 0, void 0, void 0, function* () {
