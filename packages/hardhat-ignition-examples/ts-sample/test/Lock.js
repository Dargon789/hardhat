...
describe("Lock", function () {
    ...
    function deployOneYearLockFixture() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { lock } = yield hardhat_1.ignition.deploy(LockModule_1.default, {
                parameters: {
                    LockModule: {
                        unlockTime,
                        lockedAmount,
    ...
    describe("Deployment", function () {
        it("Should set the right unlockTime", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { lock, unlockTime } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
                (0, chai_1.expect)(yield lock.unlockTime()).to.equal(unlockTime);
            });
        });
        it("Should set the right owner", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { lock, owner } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
                (0, chai_1.expect)(yield lock.owner()).to.equal(owner.address);
            });
        });
        it("Should receive and store the funds to lock", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const { lock, lockedAmount } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
                (0, chai_1.expect)(yield hardhat_1.ethers.provider.getBalance(lock.target)).to.equal(lockedAmount);
            });
        });
        it("Should fail if the unlockTime is not in the future", function () {
            return __awaiter(this, void 0, void 0, function* () {
                // We don't use the fixture here because we want a different deployment
                const latestTime = yield network_helpers_1.time.latest();
    ...
    describe("Withdrawals", function () {
        describe("Validations", function () {
            it("Should revert with the right error if called too soon", function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const { lock } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
            ...
            it("Should revert with the right error if called from another account", function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const { lock, unlockTime, otherAccount } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
        ...
        describe("Events", function () {
            it("Should emit an event on withdrawals", function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const { lock, unlockTime, lockedAmount } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
                    yield network_helpers_1.time.increaseTo(unlockTime);
        ...
        describe("Transfers", function () {
            it("Should transfer the funds to the owner", function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const { lock, unlockTime, lockedAmount, owner } = yield (0, network_helpers_1.loadFixture)(deployOneYearLockFixture);
                    yield network_helpers_1.time.increaseTo(unlockTime);
