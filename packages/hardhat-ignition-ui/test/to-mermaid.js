...
const to_mermaid_js_1 = require("../src/utils/to-mermaid.js");
describe("to-mermaid", () => {
    ...
    it("should render a module with a space in the name", () => {
        const moduleDefinition = (0, ignition_core_1.buildModule)("Test_registrar", (m) => {
            const p = m.getParameter("p", 123);
            const contract1 = m.contract("Contract1", [{ arr: [p] }]);
            return { contract1 };
        });
    ...
    it("should render a multi-module deploy diagram", () => {
        const sub1 = (0, ignition_core_1.buildModule)("Submodule1", (m) => {
            const contract1 = m.contract("Contract1", []);
            return { contract1 };
        });
        const sub2 = (0, ignition_core_1.buildModule)("Submodule2", (m) => {
    ...
    it("should render a complex diagram with all actions", () => {
        ...
        const moduleDefinition = (0, ignition_core_1.buildModule)("Module", (m) => {
            ...
            const duplicateWithLib = m.contractAt("ContractWithLibrary", withLibArtifact, withLib, { id: "ContractWithLibrary2" });
...
function assertDiagram(ignitionModule, expectedResult) {
    const result = (0, to_mermaid_js_1.toMermaid)(ignitionModule);
