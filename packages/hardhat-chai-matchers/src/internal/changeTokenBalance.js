...
function getBalanceChange(transaction, token, account) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const balanceAfter = yield token.balanceOf(address, {
            blockTag: txBlockNumber,
        });
        const balanceBefore = yield token.balanceOf(address, {
...
function getTokenDescription(token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (tokenDescriptionsCache[tokenAddress] === undefined) {
            ...
            try {
                tokenDescription = yield token.symbol();
            }
            catch (e) {
                try {
                    tokenDescription = yield token.name();
                }
                catch (e2) { }
            }
