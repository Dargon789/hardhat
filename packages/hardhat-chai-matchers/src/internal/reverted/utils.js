...
exports.parseBytes32String = exports.resultToArray = exports.decodeReturnData = exports.getReturnDataFromError = void 0;
...
function getReturnDataFromError(error) {
    ...
    error = error;
    const errorData = (_a = error.data) !== null && _a !== void 0 ? _a : (_b = error.error) === null || _b === void 0 ? void 0 : _b.data;
...
function decodeReturnData(returnData) {
    ...
    if (returnData === "0x") {
        ...
        const description = (_a = (0, panic_1.panicErrorCodeToReason)(code)) !== null && _a !== void 0 ? _a : "unknown panic code";
        return {
            kind: "Panic",
            code,
            description,
