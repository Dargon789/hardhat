...
function getBalanceChanges(transaction, accounts, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const balancesAfter = yield (0, balance_1.getBalances)(accounts, txBlockNumber);
        const balancesBefore = yield (0, balance_1.getBalances)(accounts, txBlockNumber - 1);
        const txFees = yield getTxFees(accounts, txResponse, options);
        return balancesAfter.map((balance, ind) => balance + txFees[ind] - balancesBefore[ind]);
    });
}
exports.getBalanceChanges = getBalanceChanges;
function getTxFees(accounts, txResponse, options) {
    return __awaiter(this, void 0, void 0, function* () {
        return Promise.all(accounts.map((account) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((options === null || options === void 0 ? void 0 : options.includeFee) !== true &&
                (yield (0, account_1.getAddressOf)(account)) === txResponse.from) {
                const txReceipt = yield txResponse.wait();
                (0, utils_2.assertIsNotNull)(txReceipt, "txReceipt");
                const gasPrice = (_a = txReceipt.gasPrice) !== null && _a !== void 0 ? _a : txResponse.gasPrice;
