...
function waitForPendingTransaction(tx, provider) {
        ...
        const onSuccess = (receipt) => {
            ...
            try {
                ...
                if (e instanceof TypeError) {
                    ...
                    throw new chai_1.AssertionError(errorMessage);
                }
            }
...
function emitWithArgs(context, Assertion, chaiUtils, expectedArgs, ssfi) {
    return __awaiter(this, void 0, void 0, function* () {
