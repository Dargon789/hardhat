...
const calculate_list_transactions_display_1 = require("../../../src/ui/helpers/calculate-list-transactions-display");
describe("calculateListTransactionsDisplay", function () {
    it("should serialize a bigint in transaction params", () => {
        const result = (0, calculate_list_transactions_display_1.calculateListTransactionsDisplay)("1", [
            {
                status: ignition_core_1.TransactionStatus.SUCCESS,
