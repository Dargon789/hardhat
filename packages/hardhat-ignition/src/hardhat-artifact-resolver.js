...
class HardhatArtifactResolver {
    ...
    getBuildInfo(contractName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const artifactPath = yield this._resolvePath(contractName);
            ...
            const debugJson = yield fs_1.default.promises.readFile(debugPath);
            const buildInfoPath = path_1.default.join(path_1.default.parse(debugPath).dir, JSON.parse(debugJson.toString()).buildInfo);
            const buildInfoJson = yield fs_1.default.promises.readFile(buildInfoPath);
            return JSON.parse(buildInfoJson.toString());
        });
    }
    _resolvePath(contractName) {
        return __awaiter(this, void 0, void 0, function* () {
            const artifactPaths = yield this._hre.artifacts.getArtifactPaths();
