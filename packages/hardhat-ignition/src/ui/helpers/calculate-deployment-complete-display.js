...
function calculateDeploymentCompleteDisplay(event, uiState) {
    var _a, _b;
    const moduleName = (_a = uiState.moduleName) !== null && _a !== void 0 ? _a : "unknown";
    const isResumed = (_b = uiState.isResumed) !== null && _b !== void 0 ? _b : false;
...
function _displaySuccessfulDeployment(result, { moduleName, isRerunWithNoChanges, deploymentDir, }) {
    const fillerText = isRerunWithNoChanges
        ? `Nothing new to deploy based on previous execution stored in ${(0, cwd_relative_path_1.pathFromCwd)(deploymentDir !== null && deploymentDir !== void 0 ? deploymentDir : "Not provided")}`
