...
class VerboseEventHandler {
    ...
    deploymentExecutionStateComplete(event) {
        ...
        switch (event.result.type) {
            case ignition_core_1.ExecutionEventResultType.SUCCESS: {
                return console.log(`Successfully completed the execution of deployment future ${event.futureId} with address ${(_a = event.result.result) !== null && _a !== void 0 ? _a : "undefined"}`);
            }
    ...
    staticCallExecutionStateComplete(event) {
        ...
        switch (event.result.type) {
            case ignition_core_1.ExecutionEventResultType.SUCCESS: {
                return console.log(`Successfully completed the execution of static call future ${event.futureId} with result ${(_a = event.result.result) !== null && _a !== void 0 ? _a : "undefined"}`);
            }
            case ignition_core_1.ExecutionEventResultType.ERROR: {
    ...
    sendDataExecutionStateComplete(event) {
        ...
        switch (event.result.type) {
            case ignition_core_1.ExecutionEventResultType.SUCCESS: {
                return console.log(`Successfully completed the execution of send data future ${event.futureId} in tx ${(_a = event.result.result) !== null && _a !== void 0 ? _a : "undefined"}`);
            }
            case ignition_core_1.ExecutionEventResultType.ERROR: {
                return console.log(`Execution of future ${event.futureId} failed with reason: ${event.result.error}`);
            }
    ...
    readEventArgumentExecutionStateInitialize(event) {
        var _a;
        console.log(`Executed read event argument future ${event.futureId} with result ${(_a = event.result.result) !== null && _a !== void 0 ? _a : "undefined"}`);
    }
    encodeFunctionCallExecutionStateInitialize(event) {
        var _a;
        console.log(`Executed encode function call future ${event.futureId} with result ${(_a = event.result.result) !== null && _a !== void 0 ? _a : "undefined"}`);
    }
