...
class PrettyEventHandler {
    ...
    deploymentStart(event) {
        this.state = Object.assign(Object.assign({}, this.state), { status: types_1.UiStateDeploymentStatus.DEPLOYING, moduleName: event.moduleName, deploymentDir: event.deploymentDir, isResumed: event.isResumed, maxFeeBumps: event.maxFeeBumps, disableFeeBumping: event.disableFeeBumping });
        process.stdout.write((0, calculate_starting_message_1.calculateStartingMessage)(this.state));
    }
    deploymentInitialize(event) {
        this.state = Object.assign(Object.assign({}, this.state), { chainId: event.chainId });
    }
    runStart(_event) {
    ...
    beginNextBatch(_event) {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { currentBatch: this.state.currentBatch + 1 });
        if (this.state.currentBatch === 0) {
            return;
        }
    ...
    wipeApply(event) {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { batches });
    }
    ...
    deploymentComplete(event) {
        this.state = Object.assign(Object.assign({}, this.state), { status: types_1.UiStateDeploymentStatus.COMPLETE, result: event.result, batches: this._applyResultToBatches(this.state.batches, event.result) });
    ...
    reconciliationWarnings(event) {
        this.state = Object.assign(Object.assign({}, this.state), { warnings: [...this.state.warnings, ...event.warnings] });
    }
    setModuleId(event) {
        this.state = Object.assign(Object.assign({}, this.state), { moduleName: event.moduleName });
    }
    setStrategy(event) {
        this.state = Object.assign(Object.assign({}, this.state), { strategy: event.strategy });
    }
    ledgerConnectionStart() {
        this.state = Object.assign(Object.assign({}, this.state), { ledger: true, ledgerMessage: "Connecting wallet" });
        this._redisplayCurrentBatch();
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessageIsDisplayed: true });
    }
    ledgerConnectionSuccess() {
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessage: "Wallet connected" });
        this._redisplayCurrentBatch();
    }
    ledgerConnectionFailure() {
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessage: "Wallet connection failed" });
        this._redisplayCurrentBatch();
    }
    ledgerConfirmationStart() {
        this.state = Object.assign(Object.assign({}, this.state), { ledger: true, ledgerMessage: "Waiting for confirmation on device" });
        this._redisplayCurrentBatch();
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessageIsDisplayed: true });
    }
    ledgerConfirmationSuccess() {
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessage: "Transaction approved by device" });
        this._redisplayCurrentBatch();
        this.state = Object.assign(Object.assign({}, this.state), { ledger: false });
    }
    ledgerConfirmationFailure() {
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessage: "Transaction confirmation failed" });
        this._redisplayCurrentBatch();
    }
    ...
    _setFutureStatusCompleteAndRedisplayBatch({ futureId, result, }) {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { ledgerMessageIsDisplayed: false });
    }
    _setFutureStatusAndRedisplayBatch(futureId, status) {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { batches: this._applyUpdateToBatchFuture(updatedFuture) });
        this._redisplayCurrentBatch();
    }
    ...
    _applyResultToBatches(batches, result) {
        ...
        for (const oldBatch of batches) {
            ...
            for (const future of oldBatch) {
                ...
                newBatch.push(updatedFuture !== null && updatedFuture !== void 0 ? updatedFuture : future);
            }
