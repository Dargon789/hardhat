...
describe("support changing default sender", () => {
    ...
    it("should deploy on the first HH account by default", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const [defaultAccount] = yield this.hre.ethers.getSigners();
            ...
            chai_1.assert.equal((yield result.ownerSender.owner()).toLowerCase(), defaultAccountAddress.toLowerCase());
        });
    });
    it("should allow changing the default sender that the ignition deployment runs against", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const [, notTheDefaultAccount] = yield this.hre.ethers.getSigners();
            ...
            chai_1.assert.equal((yield result.ownerSender.owner()).toLowerCase(), differentAccountAddress.toLowerCase());
        });
    });
});
